 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateCodeList.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:06 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:40:48   msg
 * Initial revision.
 *
 *    Rev 1.1   Mar 18 2002 22:49:24   msg
 * - updated copyright
 *
 *    Rev 1.0   Mar 18 2002 12:09:04   msg
 * Initial revision.
 *
...
/**
 * This operation updates a code list. The previous entries for the list are
 * replaced.
 * 
 * @version $Revision: /rgbustores_13.4x_generic_branch/1 $
 * @see oracle.retail.stores.domain.arts.CodeDataTransaction
 * @see oracle.retail.stores.domain.arts.JdbcSaveCodeList
 * @see oracle.retail.stores.domain.utility.CodeListMapIfc
 * @see oracle.retail.stores.domain.utility.CodeListIfc
 */
public class JdbcUpdateCodeList extends JdbcSaveCodeList implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = 2471814250306865828L;

    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateCodeList.class);
     ...
     * Class constructor.
     */
    public JdbcUpdateCodeList()
    {
        setName("JdbcUpdateCodeList");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateCodeList.execute()");

        JdbcDataConnection connection = (JdbcDataConnection) dataConnection;

        // Navigate the input object to obtain values that will be inserted
        // into the database.
        CodeListIfc codeList = (CodeListIfc) action.getDataObject();
        updateCodeList(connection, codeList);
    ...
    {
        return(Util.classToStringHeader("JdbcUpdateCodeList",
                                        getRevisionNumber(),
                                        hashCode()).toString());
    }
}
