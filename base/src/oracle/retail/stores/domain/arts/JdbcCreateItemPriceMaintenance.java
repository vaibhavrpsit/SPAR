 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcCreateItemPriceMaintenance.java /main/14 2012/05/21 15:50:17 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
 * $Log:
 *    5    360Commerce 1.4         5/30/2006 10:01:39 AM  Brett J. Larsen CR
 ...
 *:
 *    4    .v700     1.2.1.0     11/16/2005 16:26:50    Jason L. DeLeau 4215:
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:35:36   msg
 * Initial revision.
 *
...
**/
public class JdbcCreateItemPriceMaintenance
    extends JdbcDataOperation implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = 902401957496744095L;
    /**
        ...
        throws DataException
    {
        ...
        createItemPriceMaintenance(connection, itemPriceMaintenance);
    }
    ...
    /**
        ...
        @exception DataException upon error
     */
    protected void createItemPriceMaintenance(JdbcDataConnection dataConnection,
        ...
        throws DataException
    {
        try
        {
            ...
            SQLInsertStatement sql = buildInsertItemPriceMaintenanceSQL(itemPriceMaintenance);
     ...
     */
    protected SQLInsertStatement buildInsertItemPriceMaintenanceSQL(ItemPriceMaintenanceEventIfc itemPriceMaintenance)
        throws SQLException
    {
        ...
        // add columns
        sql.addColumn(FIELD_ITEM_PRICE_MAINTENANCE_EVENT_ID,
                      Integer.toString(itemPriceMaintenance.getEventID()));
        sql.addColumn(FIELD_RETAIL_STORE_ID, "'" + itemPriceMaintenance.getStore().getStoreID() + "'");
        sql.addColumn(FIELD_ITEM_PRICE_MAINTENANCE_TYPE_CODE,
                      "'" + EventConstantsIfc.EVENT_TYPE_CODE[itemPriceMaintenance.getTypeCode()] + "'");
        sql.addColumn(FIELD_ITEM_PRICE_MAINTENANCE_EVENT_PRIORITY, itemPriceMaintenance.getPriority());
    ...
    {
        return(Util.classToStringHeader("JdbcCreateItemPriceMaintenance",
                                        getRevisionNumber(),
                                        hashCode()).toString());
    }
