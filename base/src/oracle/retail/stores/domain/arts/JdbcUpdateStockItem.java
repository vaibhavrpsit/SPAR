 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateStockItem.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:02 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
     ...
     $:
      4    .v700     1.2.1.0     11/16/2005 16:25:52    Jason L. DeLeau 4215:
 ...
 * Initial revision.
 *
 *    Rev 1.0   Sep 20 2001 15:56:18   msg
 * Initial revision.
 *
...
/**
    This operation updates the stock item table from the StockItemIfc object. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
    @see oracle.retail.stores.domain.arts.ItemDataTransaction
    @see oracle.retail.stores.domain.stock.StockItemIfc
    @see oracle.retail.stores.domain.arts.JdbcSaveStockItem
	@deprecated As of release 13.1.
**/
public class JdbcUpdateStockItem
extends JdbcSaveStockItem
implements ARTSDatabaseIfc
{
    /**
        The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateStockItem.class);
    ...
    /**
       Class constructor.
     */
    public JdbcUpdateStockItem()
    {
        setName("JdbcUpdateStockItem");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateStockItem.execute()");

        JdbcDataConnection connection = (JdbcDataConnection) dataConnection;

        // Navigate the input object to obtain values that will be inserted
        // into the database.
        StockItemIfc item = (StockItemIfc) action.getDataObject();
        updateStockItem(connection, item);
    ...
    {
        return(Util.classToStringHeader("JdbcUpdateStockItem",
                                        getRevisionNumber(),
                                        hashCode()).toString());
    }
}
