 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllParentCalendarPeriodsInLevel.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllParentCalendarPeriodsInLevel extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllParentCalendarPeriodsInLevel.execute()";
  ...
  {
    return "JdbcFetchAllParentCalendarPeriodsInLevel - version: " + getRevisionNumber();
  }
