 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllCalendarPeriodsInLevelContainingDate.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:06 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllCalendarPeriodsInLevelContainingDate extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllCalendarPeriodsInLevelContainingDate.execute()";
    ...
    protected void fetchCalendarPeriods(CalendarDataTransaction transaction,
      ...
      // Get all periods that the given date & time are part of (in the given level)
      ...
      for(int i=0; i < periodKeys.size(); i++) {
        ...
        // Go get the period Key
        CalendarPeriodKey aKey = (CalendarPeriodKey) periodKeys.get(i);

        // Fetch the actual group
        result.add(doFetchCalendarPeriod(connection, aKey));
      }
  ...
  {
    return "JdbcFetchAllCalendarPeriodsInLevelContainingDate - version: " + getRevisionNumber();
  }
