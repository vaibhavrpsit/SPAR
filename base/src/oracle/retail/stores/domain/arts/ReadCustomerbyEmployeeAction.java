 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/ReadCustomerbyEmployeeAction.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:06 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Jun 03 2002 16:42:20   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 22:50:58   msg
 * - updated copyright
 * 
...
**/
//-------------------------------------------------------------------------
public class ReadCustomerbyEmployeeAction
    implements DataActionIfc
{
    ...
    //
    static final long serialVersionUID = -7644818329644280674L;
    ...
    protected static final String OPERATION_NAME = "ReadCustomerbyEmployee";
    ...
    **/
    //---------------------------------------------------------------------
    public ReadCustomerbyEmployeeAction(DataTransactionIfc transaction,
