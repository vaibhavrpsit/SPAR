 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllParentCalendarPeriods.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:03 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllParentCalendarPeriods extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllParentCalendarPeriods.execute()";
    ...
    protected void fetchCalendarPeriods(CalendarDataTransaction transaction,
      ...
      // Get all periods that're parents of the given period
      ArrayList periodKeys =
          doFetchParentCalendarPeriodKeys(connection,
                                          transaction.paramChildPeriod.getPeriodKey());
      ...
      for(int i=0; i < periodKeys.size(); i++) {
        ...
        // Go get the parentPeriod Key
        CalendarPeriodKey parentKey = (CalendarPeriodKey) periodKeys.get(i);

        // Fetch the actual group
        result.add(doFetchCalendarPeriod(connection, parentKey));
      }
  ...
  {
    return "JdbcFetchAllParentCalendarPeriods - version: " + getRevisionNumber();
  }
