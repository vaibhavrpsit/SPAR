 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/SaveTenderLineItemsAction.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:01 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Aug 29 2003 15:34:04   CSchellenger
 * Initial revision.
 * 
 *    Rev 1.0   Jun 03 2002 16:42:34   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 22:51:14   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 12:10:36   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 20 2001 15:56:22   msg
 * Initial revision.
 * 
...
**/
//-------------------------------------------------------------------------
public class SaveTenderLineItemsAction
    implements DataActionIfc
{
    ...
    //
    static final long serialVersionUID = 8305752083736317892L;
    ...
    **/
    //---------------------------------------------------------------------
    public SaveTenderLineItemsAction(DataTransactionIfc transaction,
                                     ARTSTransaction artsTransaction)
    {
        parent = transaction;
        dataObject = artsTransaction;
    }
