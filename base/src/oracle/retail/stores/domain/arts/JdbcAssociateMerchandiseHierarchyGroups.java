 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcAssociateMerchandiseHierarchyGroups.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:02 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   May 26 2003 17:19:20   mwright
...
/**
 *  Associates an existing merchandise classification hierarchy group
 *  as a child of another existing merchandise hierarchy classification
 *  group.<p>
 * @version $Revision: /rgbustores_13.4x_generic_branch/1 $
 */
public class JdbcAssociateMerchandiseHierarchyGroups extends JdbcMerchandiseHierarchyDataOperation
{
  /**
  ...
  */
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcAssociateMerchandiseHierarchyGroups.execute()";
     if (logger.isDebugEnabled()) logger.debug( methodName);
      ...
      // Just do it
      doAssociateGroups( (JdbcDataConnection) dataConnection,
                         transaction.paramChildGroupID,
                         transaction.paramParentGroupID,
                         transaction.paramParentLevelKey);
    ...
    {
        StringBuilder strResult = Util.classToStringHeader("JdbcAssociateMerchandiseHierarchyGroups",
