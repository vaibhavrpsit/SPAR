 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcDeAssociateCalendarLevels.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcDeAssociateCalendarLevels extends JdbcCalendarDataOperation
{
   ...
   **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcDeAssociateCalendarLevels.execute()";
     if (logger.isDebugEnabled()) logger.debug( methodName);
      ...
      doRemoveLevelAssociation((JdbcDataConnection) dataConnection,
  ...
  {
    return "JdbcDeAssociateCalendarLevels - version: " + getRevisionNumber();
  }
