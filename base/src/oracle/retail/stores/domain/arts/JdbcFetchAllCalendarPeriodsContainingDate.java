 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllCalendarPeriodsContainingDate.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:01 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllCalendarPeriodsContainingDate extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllCalendarPeriodsContainingDate.execute()";
    ...
    protected void fetchCalendarPeriods(CalendarDataTransaction transaction,
      ...
      // Get all periods that the given date & time are part of (in any level)
  ...
  {
    return "JdbcFetchAllCalendarPeriodsContainingDate - version: " + getRevisionNumber();
  }
