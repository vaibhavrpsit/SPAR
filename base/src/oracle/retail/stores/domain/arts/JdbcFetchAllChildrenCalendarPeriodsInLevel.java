 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllChildrenCalendarPeriodsInLevel.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:01 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllChildrenCalendarPeriodsInLevel extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllChildrenCalendarPeriodsInLevel.execute()";
    ...
    protected void fetchCalendarPeriods(CalendarDataTransaction transaction,
      ...
      // Get all periods that're children of the given period AND in a given level
  ...
  {
    return "JdbcFetchAllChildrenCalendarPeriodsInLevel - version: " + getRevisionNumber();
  }
