 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllCalendarPeriodsInLevel.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:03 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 */
public class JdbcFetchAllCalendarPeriodsInLevel extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllCalendarPeriodsInLevel.execute()";
    ...
    protected void fetchCalendarPeriods(CalendarDataTransaction transaction,
      ...
      // Get all periods that are in the given level
  ...
  {
    return "JdbcFetchAllCalendarPeriodsInLevel - version: " + getRevisionNumber();
  }
