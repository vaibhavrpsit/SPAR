 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcWriteCalendarLevel.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:04 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcWriteCalendarLevel extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcWriteCalendarLevel.execute()";
     if (logger.isDebugEnabled()) logger.debug( methodName);
      ...
      doWriteCalendarLevel((JdbcDataConnection) dataConnection,
  ...
  {
    return "JdbcWriteCalendarLevel - version: " + getRevisionNumber();
  }
