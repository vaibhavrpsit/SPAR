...
public class PLUTransaction extends DataTransaction implements DataTransactionIfc
{
     ...
     * @since 7.0.2
     */
    public PLUItemIfc[] getPLUItems(SearchCriteriaIfc inquiry) throws DataException
    {
     ...
     * @exception DataException is thrown if the PLUItem cannot be found.
     */
    public PLUItemIfc getPLUItem(SearchCriteriaIfc inquiry) throws DataException
    {
