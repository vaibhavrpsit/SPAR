 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateItem.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 *    Rev 1.0   Aug 29 2003 15:33:20   CSchellenger
 * Initial revision.
 *
 ...
 * Initial revision.
 *
 *    Rev 1.0   Sep 20 2001 15:56:40   msg
 * Initial revision.
 *
...
/**
 * This operation updates the item table from the ItemIfc object.
 * 
 ...
 */
public class JdbcUpdateItem extends JdbcSaveItem implements ARTSDatabaseIfc
{
    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateItem.class);
     ...
     * Class constructor.
     */
    public JdbcUpdateItem()
    {
        setName("JdbcUpdateItem");
    }
            ...
            throws DataException
    {
        if (logger.isDebugEnabled())
            logger.debug("JdbcUpdateItem.execute()");
    ...
    {
        return (Util.classToStringHeader("JdbcUpdateItem", getRevisionNumber(), hashCode()).toString());
    }
}
