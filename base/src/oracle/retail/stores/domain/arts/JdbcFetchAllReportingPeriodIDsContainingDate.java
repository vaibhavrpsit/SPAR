 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllReportingPeriodIDsContainingDate.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:01 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcFetchAllReportingPeriodIDsContainingDate extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllReportingPeriodIDsContainingDate.execute()";
     if (logger.isDebugEnabled()) logger.debug( methodName);
      ...
      // Go get the list of all periods in the given calendar for the given DATE
      result = doFetchAllReportingPeriodIDs( (JdbcDataConnection) dataConnection,                                             transaction.paramCalendarID,
  ...
  {
    return "JdbcFetchAllReportingPeriodIDsContainingDate - version: " + getRevisionNumber();
  }
