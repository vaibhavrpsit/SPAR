 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateRegisterTotals.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.1   Mar 18 2002 22:50:02   msg
 * - updated copyright
 *
 ...
 */
public class JdbcUpdateRegisterTotals extends JdbcSaveRegister implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = -2781498793938910700L;
    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateRegisterTotals.class);

    /**
     * Class constructor.
     */
    public JdbcUpdateRegisterTotals()
    {
        super();
        setName("JdbcUpdateRegisterTotals");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateRegisterTotals.execute()");
        ...
        updateRegisterTotals(connection, register);

        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateRegisterTotals.execute()");
    }

    /**
     * Updates the financial totals of a register.
     * 
     * @param dataConnection connection to the db
     * @param register the register information
     * @exception DataException upon error
     */
    public void updateRegisterTotals(JdbcDataConnection dataConnection,
                                     RegisterIfc register)
        throws DataException
    {
        try
        {
            updateWorkstationHistory(dataConnection, register);
        }
