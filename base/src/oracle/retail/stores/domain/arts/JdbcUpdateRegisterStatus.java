 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateRegisterStatus.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:02 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:41:22   msg
 * Initial revision.
 *
 *    Rev 1.1   Mar 18 2002 22:50:00   msg
 * - updated copyright
 *
 *    Rev 1.0   Mar 18 2002 12:09:32   msg
 * Initial revision.
 *
 ...
 */
public class JdbcUpdateRegisterStatus extends JdbcSaveRegister implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = 6305485340276121621L;
    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateRegisterStatus.class);

    /**
     * Class constructor.
     */
    public JdbcUpdateRegisterStatus()
    {
        super();
        setName("JdbcUpdateRegisterStatus");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateRegisterStatus.execute()");
        ...
        updateRegisterStatus(connection, register);

        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateRegisterStatus.execute()");
    }

    /**
     * Updates the status of a register.
     * 
     * @param dataConnection connection to the db
     * @param register the register status information
     * @exception DataException upon error
     */
    public void updateRegisterStatus(JdbcDataConnection dataConnection,
