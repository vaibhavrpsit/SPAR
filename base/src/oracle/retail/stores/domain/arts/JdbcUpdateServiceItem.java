 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateServiceItem.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:41:32   msg
 * Initial revision.
 *
 *    Rev 1.1   Mar 18 2002 22:50:08   msg
 * - updated copyright
 *
 *    Rev 1.0   Mar 18 2002 12:09:38   msg
 * Initial revision.
 *
 *    Rev 1.0   Sep 20 2001 15:59:04   msg
 * Initial revision.
 *
...
/**
 * This operation updates the stock item table from the ServiceItemIfc object.
 * 
 * @version $Revision: /rgbustores_13.4x_generic_branch/1 $
 * @see oracle.retail.stores.domain.arts.ItemDataTransaction
 * @see oracle.retail.stores.domain.stock.ServiceItemIfc
 * @see oracle.retail.stores.domain.arts.JdbcSaveServiceItem
 * @deprecated As of release 13.1.
 */
public class JdbcUpdateServiceItem extends JdbcSaveServiceItem implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = 3955605341029067971L;

    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateServiceItem.class);
     ...
     * Class constructor.
     */
    public JdbcUpdateServiceItem()
    {
        setName("JdbcUpdateServiceItem");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateServiceItem.execute()");
        ...
        updateServiceItem(connection, item);
    ...
    {
        return (Util.classToStringHeader("JdbcUpdateServiceItem", getRevisionNumber(), hashCode()).toString());
    }
}
