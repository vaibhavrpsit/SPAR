 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcFetchAllReportingPeriodIDsInLevelContainingDate.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:06 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcFetchAllReportingPeriodIDsInLevelContainingDate extends JdbcCalendarDataOperation
{
  ...
  **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcFetchAllReportingPeriodIDsInLevelContainingDate.execute()";
    ...
    {
      return "JdbcFetchAllReportingPeriodIDsInLevelContainingDate - version: " + getRevisionNumber();
    }
