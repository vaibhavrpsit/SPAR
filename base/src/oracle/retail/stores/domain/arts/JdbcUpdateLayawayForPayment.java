 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateLayawayForPayment.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:41:10   msg
 * Initial revision.
 *
 ...
 * Initial revision.
 *
 *    Rev 1.0   Sep 20 2001 15:56:38   msg
 * Initial revision.
 *
 ...
 */
public class JdbcUpdateLayawayForPayment extends JdbcSaveLayaway implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = -8456671012903464118L;

    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcUpdateLayawayForPayment.class);
     ...
     * Class constructor.
     */
    public JdbcUpdateLayawayForPayment()
    {
        setName("JdbcUpdateLayawayForPayment");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcUpdateLayawayForPayment.execute()");
        ...
        ARTSTransaction aTrans = (ARTSTransaction) action.getDataObject();

        if ( aTrans.getPosTransaction() instanceof LayawayPaymentTransactionIfc)
        {
            LayawayPaymentTransactionIfc lTrans =
              (LayawayPaymentTransactionIfc)aTrans.getPosTransaction();
            LayawayIfc layaway = lTrans.getLayaway();
            updateLayawayForPayment(connection, layaway);
        }
