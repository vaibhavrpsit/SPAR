 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcAssociateCalendarLevels.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:06 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 * Operation to associate two pre-existing levels.
 */
public class JdbcAssociateCalendarLevels extends JdbcCalendarDataOperation
{
  ...
  public void execute(DataTransactionIfc dataTransaction,
    ...
    String methodName = "JdbcAssociateCalendarLevels.execute()";
    ...
    doAssociateLevels((JdbcDataConnection) dataConnection,
  ...
  public String toString() {
    return "JdbcAssociateCalendarLevels - version: " + getRevisionNumber();
  }
