 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcCreateTemporaryPriceChangeItems.java /main/15 2012/05/21 15:50:17 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
 * $Log:
 *    5    360Commerce 1.4         5/30/2006 10:06:12 AM  Brett J. Larsen CR
 ...
 *:
 *    4    .v700     1.2.1.0     11/16/2005 16:28:27    Jason L. DeLeau 4215:
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:35:54   msg
 * Initial revision.
 *
 *    Rev 1.2   16 May 2002 14:41:30   adc
 * Db2 fixes
 * Resolution for Domain SCR-50: db2 port fixes
 *
 *    Rev 1.1   Mar 18 2002 22:45:22   msg
 * - updated copyright
 *
 *    Rev 1.0   Mar 18 2002 12:05:14   msg
 * Initial revision.
 *
 *    Rev 1.0   Sep 20 2001 15:58:36   msg
 * Initial revision.
 *
 ...
 */
public class JdbcCreateTemporaryPriceChangeItems extends JdbcDataOperation implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = -8944220908351865429L;
    /**
            ...
            throws DataException
    {
        ...
        createTemporaryPriceChangeItems(connection, priceChangeItems);
    }
     ...
     * @exception DataException upon error
     */
    protected void createTemporaryPriceChangeItems(JdbcDataConnection dataConnection,
        ...
        throws DataException
    {
        try
        {
            ...
            {
                SQLInsertStatement sql = buildInsertTemporaryPriceChangeItemSQL(priceChangeItems[i]);
                dataConnection.execute(sql.getSQLString());
            }
        }
        catch (SQLException se)
        {
            throw new DataException(DataException.SQL_ERROR, "createTemporaryPriceChangeItems", se);
        }
        ...
        {
            throw new DataException(DataException.UNKNOWN, "createTemporaryPriceChangeItems", e);
        }
    }
     ...
     */
    protected SQLInsertStatement buildInsertTemporaryPriceChangeItemSQL(PriceChangeIfc priceChangeItem)
        throws SQLException
    {
        ItemPriceMaintenanceEventIfc event = priceChangeItem.getPriceMaintenanceEvent();
        ...
        // add columns
        sql.addColumn(FIELD_TEMPORARY_PRICE_CHANGE_ITEM_EVENT_ID,
                      Integer.toString(event.getEventID()));
        sql.addColumn(FIELD_RETAIL_STORE_ID, "'" + event.getStore().getStoreID() + "'");
        sql.addColumn(FIELD_TEMPORARY_PRICE_CHANGE_ITEM_ITEM_ID, "'" + priceChangeItem.getItem().getItemID() + "'");
    ...
    {
        return (Util.classToStringHeader("JdbcCreatePermanentPriceChangeItems", getRevisionNumber(), hashCode())
                .toString());
    }
