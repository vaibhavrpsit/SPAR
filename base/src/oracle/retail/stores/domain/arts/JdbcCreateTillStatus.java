 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcCreateTillStatus.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 *
 *    Rev 1.0   Jun 03 2002 16:35:56   msg
 * Initial revision.
 *
 ...
 */
public class JdbcCreateTillStatus extends JdbcSaveTill implements ARTSDatabaseIfc
{
    private static final long serialVersionUID = 8959311794689209039L;
    /**
     * The logger to which log messages will be sent.
     */
    private static final Logger logger = Logger.getLogger(JdbcCreateTillStatus.class);

    /**
     * Class constructor.
     */
    public JdbcCreateTillStatus()
    {
        super();
        setName("JdbcCreateTillStatus");
    }
    ...
    {
        if (logger.isDebugEnabled()) logger.debug( "JdbcCreateTillStatus.execute()");
    ...
    /**
       ...
       @exception DataException upon error
     */
    public boolean createTillStatus(JdbcDataConnection dataConnection,
                                    TillIfc till,
