 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcDeAssociateCalendarPeriods.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:02 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcDeAssociateCalendarPeriods extends JdbcCalendarDataOperation
{
 ...
 /**
   ...
   **/
   public void execute(DataTransactionIfc dataTransaction,
     ...
     String methodName = "JdbcDeAssociateCalendarPeriods.execute()";
     if (logger.isDebugEnabled()) logger.debug( methodName);
      ...
      doRemovePeriodAssociation((JdbcDataConnection) dataConnection,
  ...
  {
    return "JdbcDeAssociateCalendarPeriods - version: " + getRevisionNumber();
  }
