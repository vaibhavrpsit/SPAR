 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcAssociateCalendarPeriods.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:48:59 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 * Operation to associate two pre-existing periods.
 */
public class JdbcAssociateCalendarPeriods extends JdbcCalendarDataOperation
{
  ...
  public void execute(DataTransactionIfc dataTransaction,
    ...
    String methodName = "JdbcAssociateCalendarPeriods.execute()";
    ...
    doAssociatePeriods((JdbcDataConnection) dataConnection,
   ...
   if (logger.isDebugEnabled()) logger.debug( methodName);
    ...
    {
      return "JdbcAssociateCalendarPeriods - version: " + getRevisionNumber();
    }
