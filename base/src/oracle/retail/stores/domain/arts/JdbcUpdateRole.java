 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcUpdateRole.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:03 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 22:50:06   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 12:09:36   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 20 2001 15:56:28   msg
 * Initial revision.
 * 
...
**/
//-------------------------------------------------------------------------
public class JdbcUpdateRole extends JdbcSaveRole
{
    /** 
        The logger to which log messages will be sent.
    **/
    private static Logger logger = Logger.getLogger(oracle.retail.stores.domain.arts.JdbcUpdateRole.class);
    ...
    **/
        ...
        throws DataException
    {
        ...
        dataTransaction.setResult(updateRole(connection, role));
    }
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  JdbcUpdateRole (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
