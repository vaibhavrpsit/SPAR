 ...
 * ===========================================================================
 * $Header: rgbustores/modules/domain/src/oracle/retail/stores/domain/arts/JdbcWriteCalendar.java /rgbustores_13.4x_generic_branch/1 2011/05/04 11:49:02 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 */
public class JdbcWriteCalendar extends JdbcCalendarDataOperation
{
  ...
  public void execute(DataTransactionIfc dataTransaction,
    ...
    String methodName = "JdbcWriteCalendar.execute()";
    ...
    // Just do it
    doWriteCalendar((JdbcDataConnection) dataConnection,
  ...
  {
    return "JdbcWriteCalendar - version: " + getRevisionNumber();
  }
