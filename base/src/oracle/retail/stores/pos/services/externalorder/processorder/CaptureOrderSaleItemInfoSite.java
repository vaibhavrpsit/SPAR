 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/externalorder/processorder/CaptureOrderSaleItemInfoSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:59 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
 * This site calls the order sell item station for each plu item
 *
 * @author acadar
 *
 */
public class CaptureOrderSaleItemInfoSite extends PosSiteActionAdapter
{
     ...
     *  Serial Version UID
     */
    private static final long serialVersionUID = 1511843505606952529L;
