 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/specialorder/add/IsOfflineSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:02 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:02:12   msg
 * Initial revision.
 * 
...
//--------------------------------------------------------------------------
/**
    This determines if there was a failure when trying to link the customer.
    <P>
...
public class IsOfflineSignal implements TrafficLightIfc
{
    ...
    //
    static final long serialVersionUID = 8323584520056791935L;
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Determines whether a customer link failure has occurred due to the 
        system being offline.
        <p>
        @param bus the bus trying to proceed
        @return true if a data exception error occurred, database offline
    **/
    //----------------------------------------------------------------------
