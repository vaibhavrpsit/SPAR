 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/manager/registerreports/OrdersSummaryReportSelectedAisle.java /main/10 2011/02/16 09:13:27 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Nov 04 2003 13:53:02   rrn
 * Initial revision.
 * 
 * ===========================================================================
 */
 ...
 */
public class OrdersSummaryReportSelectedAisle extends PosLaneActionAdapter
{
    private static final long serialVersionUID = 8244691419747093503L;

    public static final String LANENAME = "OrdersSummaryReportSelectedAisle";
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setAccessFunctionID(RoleFunctionIfc.REPORT_ORDER_SUMMARY);
