 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/manager/registerreports/SummaryReportSelectedAisle.java /main/10 2011/02/16 09:13:27 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Nov 04 2003 13:53:06   rrn
 * Initial revision.
 * 
 * ===========================================================================
 */
 ...
 */
public class SummaryReportSelectedAisle extends PosLaneActionAdapter
{
    private static final long serialVersionUID = -6227620451853104416L;

    public static final String LANENAME = "SummaryReportSelectedAisle";
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setAccessFunctionID(RoleFunctionIfc.REPORT_SUMMARY);
