 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/ModifyTransactionGiftRegistryLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:14:10   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:38:22   msg
 * Initial revision.
 * 
 *    Rev 1.2   21 Jan 2002 17:51:14   baa
 * converting to new security model
 * Resolution for POS SCR-309: Convert to new Security Override design.
 *
 *    Rev 1.1   18 Jan 2002 19:03:02   baa
 * convert to new security model
 * Resolution for POS SCR-309: Convert to new Security Override design.
 *
 *    Rev 1.0   Sep 21 2001 11:30:20   msg
 * Initial revision.
 *
 *    Rev 1.1   Sep 17 2001 13:09:32   msg
 * header update
 * ===========================================================================
 */
...
//------------------------------------------------------------------------------
/**
    Launch shuttle class for ModifyTransactionGiftRegistry service. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class ModifyTransactionGiftRegistryLaunchShuttle extends FinancialCargoShuttle
{
    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.modifytransaction.ModifyTransactionGiftRegistryLaunchShuttle.class);
    ...
    **/
    ...
    public void load(BusIfc bus)
    {
        ...
        // pull out gift registry, line items
        RetailTransactionIfc transaction = cargo.getTransaction();

        if (transaction != null)
        {
            lineItems = transaction.getLineItemsVector();
            defaultRegistry = ((SaleReturnTransactionIfc)transaction).getDefaultRegistry();
    ...
    //---------------------------------------------------------------------
    /**
       Unload to child (ModifyTransactionGiftRegistry) cargo class. <P>
       <B>Pre-Condition</B>
       <UL>
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        cargo = (ModifyTransactionGiftRegistryCargo) bus.getCargo();

        // initialize cargo with line items, gift registry
        cargo.initialize(lineItems, defaultRegistry);
    ...
    **/
    ...
    public String toString()
    {
        ...
        // result string
        String strResult = new String("Class:  ModifyTransactionGiftRegistryLaunchShuttle (Revision " +
                                      getRevisionNumber() +
                                      ")" +
                                      hashCode());
