 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/tax/EnterTaxRateSite.java /main/14 2011/12/05 12:16:20 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
     $Log:
      5    360Commerce 1.4         3/29/2007 6:43:29 PM   Michael Boyd    CR
           26172 - v8x merge to trunk

           5    .v8x      1.3.1.0     3/12/2007 12:05:52 PM  Brett J. Larsen
           CR 4530
 ...
 * Initial revision.
 *
 *    Rev 1.2   Mar 05 2003 14:42:22   HDyer
 ...
 *
 *    Rev 1.0   Apr 29 2002 15:14:40   msg
 * Initial revision.
 *
 ...
 *
 *    Rev 1.0   Sep 21 2001 11:31:52   msg
 * Initial revision.
 *
...
**/
//--------------------------------------------------------------------------
public class EnterTaxRateSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        CodeListIfc reasons = utility.getReasonCodes(cargo.getOperator().getStoreID(), CodeConstantsIfc.CODE_LIST_TRANSACTION_TAX_RATE_OVERRIDE_REASON_CODES);
        cargo.setLocalizedOverrideRateReasonCodes(reasons);
        ...
        if (tax != null && tax.getTaxMode() == TaxIfc.TAX_MODE_OVERRIDE_RATE)
        {
        ...
        uiManager.showScreen(POSUIManagerIfc.TRANSACTION_TAX_OVERRIDE_RATE, beanModel);
