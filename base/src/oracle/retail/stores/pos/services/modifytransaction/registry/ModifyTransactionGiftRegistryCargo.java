 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/registry/ModifyTransactionGiftRegistryCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:31 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Apr 09 2003 11:27:48   bwf
 * Deprecation Fixes
 * Resolution for 2103: Remove uses of deprecated items in POS.
 * 
 *    Rev 1.0   Apr 29 2002 15:16:10   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:38:56   msg
 * Initial revision.
 * 
 *    Rev 1.1   21 Jan 2002 17:51:18   baa
...
//--------------------------------------------------------------------------
/**
    Cargo class for ModifyTransactionRegistryIDIfc service. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class ModifyTransactionGiftRegistryCargo extends AbstractFinancialCargo
                                                implements TransactionCargoIfc
{
    ...
    **/
    ...
    /**
        default gift registry (from transaction)
    **/
    protected RegistryIDIfc defaultRegistry;
    /**
        new gift registry
    **/
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
        Constructs ModifyTransactionGiftRegistryCargo object. <P>
    **/
    //---------------------------------------------------------------------
    public ModifyTransactionGiftRegistryCargo()
    {                                   // begin ModifyTransactionGiftRegistryCargo()
    }                                   // end ModifyTransactionGiftRegistryCargo()

    //---------------------------------------------------------------------
    /**
        Initializes cargo, setting gift registry value and checking for
        modified item gift registry. <P>
        @param lineItems  Vector of transaction line items
        @param defaultGift  default gift registry
    **/
    //---------------------------------------------------------------------
    public void initialize(Vector lineItems,
                           RegistryIDIfc defaultGift)
    {
        // set default-sales-associate attribute
        defaultRegistry = defaultGift;
        newRegistry = defaultGift;
    ...
    /**
        ...
        @return boolean  indicator set to true if items have been modified
    **/
    //---------------------------------------------------------------------
    ...
    {                                   // begin checkModifiedFlags()
        ...
        {                               // begin loop through line items
            ...
            if (srli.getRegistryModifiedFlag())
            {
    ...
    **/
    ...
    //---------------------------------------------------------------------
     //---------------------------------------------------------------------
    /**
        Sets default gift registry. <P>
        @param value  new default gift registry
    **/
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    /**
        Returns default gift registry. <P>
        @return default gift registry
    **/
    //---------------------------------------------------------------------
    ...
    /**
        ...
        <B>Post-Condition</B>
        <UL>
        <LI>dirty flag set to true
        </UL>
        @param value  new gift registry
    **/
    //---------------------------------------------------------------------
    public void setNewRegistry(RegistryIDIfc value)
    {
        newRegistry = value;
        dirtyFlag = true;
    }
    ...
    //---------------------------------------------------------------------
    /**
        Returns new gift registry. <P>
        @return new gift registry
    **/
    //---------------------------------------------------------------------
    public RegistryIDIfc getNewRegistry()
    {
        return(newRegistry);
    }
    ...
    **/
    ...
    {
        return RoleFunctionIfc.SET_GIFT_REGISTRY;
    }
    //--------------------------------------------------------------------------
    /**
    ...
    **/
    ...
    //---------------------------------------------------------------------
    /**
        Displays string representation of object. <P>
    ...
    **/
    ...
    public String toString()
    {
        ...
        // result string
        String strResult = new String("Class:  ModifyTransactionGiftRegistryCargo (Revision " +
                                      getRevisionNumber() +
                                      ")" +
                                      hashCode());
