 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifytransaction/resume/DisplaySuspendedNextAisle.java /main/11 2014/05/14 14:41:28 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:15:50   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:39:10   msg
 * Initial revision.
 * 
 *    Rev 1.1   Jan 19 2002 10:28:24   mpm
...
/**
 * Resumes selected transaction summary from user interface.
 * 
 * @version $Revision: /main/11 $
 */
@SuppressWarnings("serial")
public class DisplaySuspendedNextAisle extends PosLaneActionAdapter
{
    /**
     ...
     * lane name constant
     */
    public static final String LANENAME = "DisplaySuspendedNextAisle";

    /**
     * Resumes selected reason code from user interface.
     * 
