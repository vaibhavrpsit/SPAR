 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/validate/CheckForAlterationItemsSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 16:17:10 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.1   08 Nov 2003 01:26:38   baa
 * cleanup -sale refactoring
 * 
 *    Rev 1.0   Nov 04 2003 16:06:54   sfl
 * Initial revision.
...
**/
//--------------------------------------------------------------------------
public class CheckForAlterationItemsSite extends PosSiteActionAdapter
{
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Check if the transaction contains alteration item(s) and mail a proper letter
        <P>
