 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/sale/IsCustomerInfoSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 16:17:10 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 *   Revision 1.1  2004/02/20 21:13:42  aschenk
 ...
 */
public class IsCustomerInfoSignal implements TrafficLightIfc
{
    static final long serialVersionUID = -304166659888772956L;
     ...
     */
    private static final Logger logger = Logger.getLogger(IsCustomerInfoSignal.class);
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        logger.debug("IsCustomerInfoSignal.roadClear() - entry");
        ...
        logger.debug("IsCustomerInfoSignal.roadClear() - exit");
        return (result);
    }
