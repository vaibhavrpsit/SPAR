 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/customer/delete/CustomerLookupReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:26 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   11 Dec 2001 08:42:00   baa
 * Initial revision.
...
public class CustomerLookupReturnShuttle implements ShuttleIfc
{
    ...
    //
    static final long serialVersionUID = -3989019376696316566L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.customer.delete.CustomerLookupReturnShuttle.class);
