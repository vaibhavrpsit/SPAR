 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/validateid/GetIDCountrySite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:11 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
/**
    This class displays the ID Country Origin screen.
    $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class GetIDCountrySite extends PosSiteActionAdapter
{
    /**
    ...
    **/
    ...
    {       
        ...
        ui.showScreen(POSUIManagerIfc.ENTER_COUNTRY, model);  
    }
    ...
    public void depart(BusIfc bus)
    {
        ...
        if (letter.getName().equals("Next"))
        {
            ...
            CheckEntryBeanModel model = (CheckEntryBeanModel) 
                                    ui.getModel(POSUIManagerIfc.ENTER_COUNTRY);
            ValidateIDCargoIfc cargo = (ValidateIDCargoIfc)bus.getCargo();
            
            cargo.setIDState(null);
