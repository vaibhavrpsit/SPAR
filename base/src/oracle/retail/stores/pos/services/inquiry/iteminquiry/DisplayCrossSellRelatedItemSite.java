...
* ===========================================================================
* $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/inquiry/iteminquiry/DisplayCrossSellRelatedItemSite.java /main/1 2012/11/08 17:29:02 yiqzhao Exp $
* ===========================================================================
* NOTES
...
public class DisplayCrossSellRelatedItemSite extends DisplayRelatedItemSite
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        ui.showScreen(POSUIManagerIfc.ITEM_INQUIRY_CROSS_SELL_RELATED_ITEMS, relatedItemBeanModel);
    }
