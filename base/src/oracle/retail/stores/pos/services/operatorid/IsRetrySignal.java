 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/operatorid/IsRetrySignal.java /main/10 2013/07/12 15:00:49 mkutiana Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:40:26   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:32:04   msg
 * Initial revision.
 * 
...
//--------------------------------------------------------------------------
/**
    Indicates that user has more logon attempts available.

     <P>
     @version $Revision: /main/10 $
**/
//--------------------------------------------------------------------------
public class IsRetrySignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -5073920541234934191L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.operatorid.IsRetrySignal.class);
    ...
    **/
    ...
    /**
        signal name
    **/
    public static final String SIGNALNAME = "IsRetrySignal";

    //--------------------------------------------------------------------------
    /**
       roadClear determines whether it is safe for the bus to proceed
       @param bus the bus trying to proceed
       @return true if user still has log on attempts; false otherwise
    **/
    //--------------------------------------------------------------------------
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        // The site should do a retry if the error is a no_data exception AND
        // If lockout is not there
