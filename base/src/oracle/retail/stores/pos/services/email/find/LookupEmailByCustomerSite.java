 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/email/find/LookupEmailByCustomerSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:29 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 *   Revision 1.5  2004/03/03 23:15:13  bwf
 *   @scr 0 Fixed CommonLetterIfc deprecations.
 *
 *   Revision 1.4  2004/02/12 16:50:12  mcs
 ...
 *
 *
 *    Rev 1.0   Aug 29 2003 15:58:54   CSchellenger
 * Initial revision.
 *
 *    Rev 1.2   Jul 31 2002 09:26:22   jriggins
 * First checkin didn't work due to incorrect privledges.
 * Resolution for POS SCR-1740: Code base Conversions
 *
 *    Rev 1.1   Jul 31 2002 09:05:10   jriggins
 * Changed from Integer.parseInt()
 *
 * Removed unecessary imports.
 * Resolution for POS SCR-1740: Code base Conversions
 *
 *    Rev 1.0   Apr 29 2002 15:24:48   msg
 * Initial revision.
 *
 *    Rev 1.0   Mar 18 2002 11:31:46   msg
 * Initial revision.
 *
 *    Rev 1.0   Sep 24 2001 11:17:34   MPM
 * Initial revision.
 *
 *    Rev 1.1   Sep 17 2001 13:07:40   msg
 * header update
 * ===========================================================================
 */
...
public class LookupEmailByCustomerSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    /**
       site name constant
    **/
    public static final String SITENAME = "LookupEmailByCustomerSite";
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        cargo.setSearchMethod(EmailCargo.SEARCH_BY_CUSTOMER);
        ...
        {
            emsgList =
              eTransaction.retrieveEMessagesByCustomer
                (customer, storeID, beginDate, endDate);
            ...
            {
                result = new Letter(CommonLetterIfc.TOO_MANY);  // too many for status search
                logger.error(
                             "Error:  too many matches (> " + Integer.toString(maxMatchesInt) + ")");
            }
            else
            {
