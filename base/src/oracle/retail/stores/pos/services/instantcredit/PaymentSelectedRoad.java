...
* ===========================================================================
* $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/instantcredit/PaymentSelectedRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/24 19:03:16 sgu Exp $
* ===========================================================================
* NOTES
...
public class PaymentSelectedRoad extends LaneActionAdapter
{
    //----------------------------------------------------------------------
    /**
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setProcess(InstantCreditCargo.PROCESS_PAYMENT);
    }
}
