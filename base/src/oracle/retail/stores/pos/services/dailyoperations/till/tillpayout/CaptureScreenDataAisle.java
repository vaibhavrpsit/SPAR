 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/CaptureScreenDataAisle.java /main/14 2011/02/16 09:13:26 cgreene Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
     ...
     $Log:
      ...
      4    360Commerce 1.3         3/29/2007 6:22:58 PM   Michael Boyd    CR
           26172 - v8x merge to trunk

           4    .v8x      1.2.1.0     3/11/2007 7:22:58 PM   Brett J. Larsen
           CR 4530
     ...
     Revision 1.6  2004/07/30 21:18:53  dcobb
     ...
     Revision 1.5  2004/07/27 18:30:59  jdeleau
...
/**
 * CaptureScreenDataAisle for the till pay out use case. Captures the
                                    ...
                                    implements LaneActionIfc
{
    ...
    static final long serialVersionUID = 4630603714019936062L;
    ...
    public void traverse(BusIfc bus)
    {
        ...
        EnterTillPayOutBeanModel model =
            (EnterTillPayOutBeanModel) ui.getModel(POSUIManagerIfc.PAY_OUT);
