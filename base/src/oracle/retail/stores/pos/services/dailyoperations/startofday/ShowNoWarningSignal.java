 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/startofday/ShowNoWarningSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:29:22   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:15:38   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:28:14   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:16:30   msg
 * Initial revision.
 * 
...
public class ShowNoWarningSignal implements TrafficLightIfc
{
    ...
    //
    static final long serialVersionUID = 234038424830254378L;
    ...
    **/
    ...
    {
        String strResult = new String("Class:  ShowNoWarningSignal (Revision "
                                      + getRevisionNumber()
                                      + ")" + hashCode());
        return(strResult);
    }
