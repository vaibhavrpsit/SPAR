 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/UncountedTendersAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:30:48   msg
 * Initial revision.
 * 
...
**/
//--------------------------------------------------------------------------
public class UncountedTendersAisle extends PosLaneActionAdapter
{
    /**
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  UncountedTendersAisle (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
    ...
    **/
    ...
    {                                   // begin main()
        // instantiate class
        UncountedTendersAisle obj = new UncountedTendersAisle();
