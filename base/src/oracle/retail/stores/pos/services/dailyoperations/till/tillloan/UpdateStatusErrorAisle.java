 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillloan/UpdateStatusErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:17 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:29:18   msg
 * Initial revision.
 * 
 ...
 * Initial revision.
 *
 *    Rev 1.1   Sep 17 2001 13:14:28   msg
 * header update
 * ===========================================================================
 */
...
public class UpdateStatusErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = 2533048111477210587L;
     ...
     * loan text tag
     */
    protected static String LOAN_TAG = "TillUpdateDatabaseError.Loan";
    /**
     * loan text
     */
    protected static String LOAN = "loan";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText(LOAN_TAG, LOAN);
