 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/endofday/RegisterOpenErrorSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:13:54   msg
 * - updated copyright
 * 
...
**/
//--------------------------------------------------------------------------
public class RegisterOpenErrorSite extends PosSiteActionAdapter
{
    /**
        revision number
    **/
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setResourceID("StoreCloseRegisterOpenError");
