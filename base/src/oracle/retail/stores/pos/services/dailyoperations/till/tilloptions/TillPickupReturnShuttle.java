 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tilloptions/TillPickupReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:19 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
    Transfers data from TillPickup service to TillOptions service. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class TillPickupReturnShuttle implements ShuttleIfc
{                                       // begin class TillPickupReturnShuttle
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -2243505980363810519L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.till.tilloptions.TillPickupReturnShuttle.class);
    ...
    **/
    public static final String SHUTTLENAME = "TillPickupReturnShuttle";
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Loads data from the TillPickup service. <P>
    ...
    **/
    ...
    {                                   // begin load()
        ...
        register = pickupCargo.getRegister();
        storeStatus = pickupCargo.getStoreStatus();
        lastReprintableTransactionID = pickupCargo.getLastReprintableTransactionID();
    ...
    **/
    ...
    {                                   // begin unload()
        ...
        cargo.setTransaction(pickupCargo.getTransaction());
    }                                   // end unload()
...
}                                       // end class TillPickupReturnShuttle
