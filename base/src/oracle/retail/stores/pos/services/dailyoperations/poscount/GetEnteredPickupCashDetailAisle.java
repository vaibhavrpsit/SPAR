 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/GetEnteredPickupCashDetailAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Feb 06 2004 17:09:34   DCobb
 * Initial revision.
 * ===========================================================================
 */
...
//--------------------------------------------------------------------------
/**
    Save the entered pickup cash detail count to the cargo.
    <p>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class GetEnteredPickupCashDetailAisle extends PosLaneActionAdapter
{
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Saves the entered pickup cash detail count to the cargo and mails a  
       Continue letter. <p>
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        CurrencyDetailBeanModel beanModel = (CurrencyDetailBeanModel)ui.getModel(POSUIManagerIfc.CURRENCY_DETAIL_PICKUP);
        ...
        cargo.setPickupAndLoanToRegister(beanModel.getRegister());
        cargo.setPickupAndLoanFromRegister(cargo.getRegister().getWorkstation().getWorkstationID());
