 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/EnterLoanCashDetailSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
...
//------------------------------------------------------------------------------
/**
     Display the count loan cash detail screen. 
     @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------

public class EnterLoanCashDetailSite extends PosSiteActionAdapter implements SiteActionIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 8790560445703415750L;
    ...
    **/
    public static final String SITENAME = "EnterLoanCashDetailSite";
    /**
    ...
    **/
    ...
    /**
        spec name constant
    **/
    protected static String CURRENCY_DETAIL_LOAN_SPEC_NAME = "CurrencyDetailLoanSpec";

    //--------------------------------------------------------------------------
    /**
       Display the count loan cash detail screen.  Only local cash for loan 
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (beanModel == null)
        {
            ...
            beanModel.setLoanFlag(true);
            beanModel.setPickupFlag(false);
            beanModel.setRegister(cargo.getPickupAndLoanFromRegister());
        }
        ...
        argumentText.append(" ")
                    .append(utility.retrieveText(CURRENCY_DETAIL_LOAN_SPEC_NAME,
        ...
        // Display the screen
        ui.showScreen(POSUIManagerIfc.CURRENCY_DETAIL_LOAN, beanModel);
    }
}
