 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/OpenDrawerSite.java /main/11 2012/09/12 11:57:09 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class OpenDrawerSite extends PosSiteActionAdapter
{
    ...
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYOUT_TAG = 
      "CashDrawerRetryContinueCancel.payout";
    public static final String CASH_DRAWER_RETRY_CONT_CANCEL_PAYOUT_TEXT = 
      "payout";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        transaction.setTransactionType(TransactionIfc.TYPE_PAYOUT_TILL);
        utility.initializeTransaction(transaction, -1);
        
        cargo.setTransaction(transaction);
        TillCashDrawer.
        tillOpenCashDrawer(bus,util.retrieveDialogText(CASH_DRAWER_RETRY_CONT_CANCEL_PAYOUT_TAG,
                                                          CASH_DRAWER_RETRY_CONT_CANCEL_PAYOUT_TEXT));
     }
