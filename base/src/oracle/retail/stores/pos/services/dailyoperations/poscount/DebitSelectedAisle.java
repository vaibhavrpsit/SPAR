 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/DebitSelectedAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:14:20   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:27:04   msg
 * Initial revision.
 * 
 *    Rev 1.1   02 Mar 2002 12:47:38   pdd
...
**/
//--------------------------------------------------------------------------
public class DebitSelectedAisle extends PosLaneActionAdapter
{
    /**
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setCurrentActivityOrCharge(
            DomainGateway.getFactory()
                         ...
                         .getDescriptor(TenderLineItemIfc.TENDER_TYPE_DEBIT));
