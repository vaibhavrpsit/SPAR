 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/endofday/StoreUpdateErrorSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:14:02   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:26:48   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:16:16   msg
 * Initial revision.
 * 
...
**/
//------------------------------------------------------------------------------
public class StoreUpdateErrorSite extends PosSiteActionAdapter
{                                       // begin class StoreUpdateErrorSite
    /**
        revision number
    **/
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setResourceID("StoreCloseUpdateError");
...
}                                       // end class StoreUpdateErrorSite
