 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillresume/UpdateStatusErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:21 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:26:02   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:31:04   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 10 2002 18:00:20   mpm
...
public class UpdateStatusErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = 82250400740368362L;
     ...
     * resume text tag
     */
    protected static String RESUME_TAG = "TillUpdateDatabaseError.Resume";
    /**
     * resume text
     */
    protected static String RESUME = "resume";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText(RESUME_TAG,
                                             RESUME);
