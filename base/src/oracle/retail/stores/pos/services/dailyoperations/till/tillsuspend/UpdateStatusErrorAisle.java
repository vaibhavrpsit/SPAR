 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillsuspend/UpdateStatusErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:25:38   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:31:22   msg
 * Initial revision.
 * 
...
public class UpdateStatusErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = 6571567028569270685L;
     ...
     * suspend text tag
     */
    protected static String SUSPEND_TAG = "TillUpdateDatabaseError.Suspend";
    /**
     * suspend text
     */
    protected static String SUSPEND = "suspend";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText(SUSPEND_TAG, SUSPEND);
