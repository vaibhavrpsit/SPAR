 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/PrintReceiptSite.java /main/13 2011/12/13 08:55:49 icole Exp $
 * ===========================================================================
 * NOTES
 * <other useful comments, qualifications, etc.>
 *
 * MODIFIED    (MM/DD/YY)
 *    icole     12/13/11 - Forward port of 12879656, show printer offline
 *                         dialog when printer is offline for till payout.
...
{
    private static final long serialVersionUID = -7860073044826018026L;

    public static final String revisionNumber = "$Revision: /main/13 $";
    public static final String tillPayoutReceiptCount = "NumberTillPayoutReceipts";
     ...
     */
    protected static String TILL_PAYOUT_TAG = "TillPayOut";

    /**
     * @deprecated as of 13.1 use blueprint configuration instead
     */
    protected static String TILL_PAYOUT_TEXT = "Till pay out";
    ...
    public void arrive(BusIfc bus)
    {
        ...
        catch (PrintableDocumentException e)
        {
            ...
            statusModel.setStatus(POSUIManagerIfc.PRINTER_STATUS, POSUIManagerIfc.OFFLINE);            mailLetter = false;
            mailLetter = false;
