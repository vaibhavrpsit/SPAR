 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillsuspend/CheckStatusCashierErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:25:18   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:31:08   msg
 * Initial revision.
 * 
 *    Rev 1.2   Mar 10 2002 18:00:20   mpm
 * Externalized text in dialog messages.
 * Resolution for POS SCR-351: Internationalization
 *
 *    Rev 1.1   05 Dec 2001 15:29:28   epd
 * added arg to dialogue message
 * Resolution for POS SCR-78: Wrong EM - diff user tries to suspend a till in Cash Acct.
 *
 *    Rev 1.0   Sep 21 2001 11:20:24   msg
 * Initial revision.
 *
 *    Rev 1.1   Sep 17 2001 13:15:24   msg
 * header update
 * ===========================================================================
 */
...
public class CheckStatusCashierErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = -8428934581288664945L;


    public static final String LANENAME = "CheckStatusCashierErrorAisle";
    /**
     * no open till prompt tag
     */
    protected static String NO_OPEN_TILL_TAG = "TillCashierHasNoTillAssignedError.NoOpenTill";
    /**
     * no open till prompt
     */
    protected static String NO_OPEN_TILL = "You do not have an open till";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        args[0] = utility.retrieveDialogText(NO_OPEN_TILL_TAG, NO_OPEN_TILL);
        model.setArgs(args);
