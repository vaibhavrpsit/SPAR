 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/PayOutAmountErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * @author khassen
 *
 * Displays a dialog on an error when attempting to do a pay out.
 */
public class PayOutAmountErrorAisle extends PosLaneActionAdapter
                                        implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = 8186043212063286077L;



    public static final String LANENAME = "PayOutAmountErrorAisle";
