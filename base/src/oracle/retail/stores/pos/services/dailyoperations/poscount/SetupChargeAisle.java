 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/SetupChargeAisle.java /main/13 2012/10/16 17:37:28 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class SetupChargeAisle extends PosLaneActionAdapter
{
    ...
    {
        // result string
        String strResult = new String("Class:  SetupChargeAisle (Revision " + getRevisionNumber() + ")" + hashCode());
