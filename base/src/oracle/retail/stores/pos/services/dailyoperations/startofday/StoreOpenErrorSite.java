 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/startofday/StoreOpenErrorSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:16:02   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:28:18   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:16:44   msg
 * Initial revision.
 * 
...
//--------------------------------------------------------------------------
/**
    Displays store-is-already-open error message. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class StoreOpenErrorSite extends PosSiteActionAdapter
{
    /**
        revision number
    **/
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setResourceID("StoreOpenError");
