 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/IsNotCashTenderSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:23 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Aug 29 2003 15:56:54   CSchellenger
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:30:32   msg
 * Initial revision.
 * 
 ...
 * Initial revision.
 * 
 *    Rev 1.1   02 Mar 2002 12:47:44   pdd
...
**/
//--------------------------------------------------------------------------
public class IsNotCashTenderSignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -840586561769031355L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.poscount.IsNotCashTenderSignal.class);
    ...
    **/
    ...
    public static final String SIGNALNAME = "IsNotCashTenderSignal";
