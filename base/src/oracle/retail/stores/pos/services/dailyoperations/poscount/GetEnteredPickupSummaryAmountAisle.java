 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/poscount/GetEnteredPickupSummaryAmountAisle.java /main/15 2011/12/05 12:16:18 cgreene Exp $
 * ===========================================================================
 * NOTES
...
//--------------------------------------------------------------------------
/**
    Stores the amount and the 'to' register entered.
    <p>
    @version $Revision: /main/15 $
**/
//--------------------------------------------------------------------------
public class GetEnteredPickupSummaryAmountAisle extends PosLaneActionAdapter
{
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Gets the Pickup Summary Amount and the To Register and saves it
       in the cargo.
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        String currencyText = (LocaleUtilities.parseCurrency(
                               (String)datamodel.getValueAsString("amountField"), defaultLocale)).toString();
        cargo.setCurrentAmountStr(currencyText);

        String toRegister = (String)datamodel.getValueAsString("toRegisterField");
        cargo.setPickupAndLoanToRegister(toRegister);
