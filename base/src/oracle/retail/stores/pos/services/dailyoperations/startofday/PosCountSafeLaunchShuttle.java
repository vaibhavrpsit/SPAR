 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/startofday/PosCountSafeLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:15:32   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:28:10   msg
 * Initial revision.
 * 
 *    Rev 1.1   23 Jan 2002 13:05:04   epd
...
public class PosCountSafeLaunchShuttle implements ShuttleIfc
{
    ...
    //
    static final long serialVersionUID = 8977192243650730535L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.startofday.PosCountSafeLaunchShuttle.class);

    public static final String SHUTTLENAME = "PosCountSafeLaunchShuttle";

    private StartOfDayCargo startCargo;
    ...
    **/
    ...
    public void load(BusIfc bus)
    {
        ...
        startCargo = (StartOfDayCargo) bus.getCargo();
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        RegisterIfc register = (RegisterIfc) startCargo.getRegister().clone();
        
        // Setup poscount cargo
        cargo.setRegister(register);

        cargo.setCountType(PosCountCargo.START_SAFE);

        cargo.setFinancialTotals(startCargo.getSafeTotals());

        if (startCargo.getSafeCountType() == FinancialCountIfc.COUNT_TYPE_SUMMARY)
        {
