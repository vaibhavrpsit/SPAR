 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/startofday/BusinessDateReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
 * $Log:
 *    4    360Commerce 1.3         3/5/2008 11:46:04 PM   Chengegowda Venkatesh
 *          CR 30716
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:29:10   msg
 * Initial revision.
 * 
...
/**
    ...
    the BusinessDate service to the StartOfDay service. <P>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class BusinessDateReturnShuttle implements ShuttleIfc
{                                       // begin class BusinessDateReturnShuttle
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 4688020722710224492L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.startofday.BusinessDateReturnShuttle.class);
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Copies information from the cargo used in the BusinessDate service. <P>
    ...
    **/
    ...
    //--------------------------------------------------------------------------
    /**
       Copies information to the cargo used in the StartOfDay service. <P>
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        cargo.setInputBusinessDate(selectedBusinessDate);
        
        //For Audit log
        StoreOpsEvent ev = (StoreOpsEvent)AuditLoggingUtils.createLogEvent(StoreOpsEvent.class, AuditLogEventEnum.ENTER_BUSINESS_DATE);
        AuditLoggerServiceIfc auditService = AuditLoggingUtils.getAuditLogger();
        
        ev.setEventOriginator("BusinessDateLaunchShuttle.load");
        EYSDate eysdate = cargo.getInputBusinessDate();
        if(eysdate!=null)
        {
        	ev.setBusinessDate(eysdate.dateValue());
        }
        ...
        EmployeeIfc ei = cargo.getOperator();
        if(ei!=null)
        {
        	ev.setUserId(ei.getLoginID());
        }
...
}                                       // end class BusinessDateReturnShuttle
