 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillpayout/TillPayOutCargo.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
     ...
     $Log:
      ...
      4    360Commerce 1.3         3/29/2007 6:24:03 PM   Michael Boyd    CR
           26172 - v8x merge to trunk

           4    .v8x      1.2.1.0     3/11/2007 7:24:38 PM   Brett J. Larsen
           CR 4530
     ...
     $
     Revision 1.6  2004/07/22 04:56:57  khassen
 ...
 * @author khassen
 *
 * Cargo for the pay out use case.
 */
public class TillPayOutCargo extends TillCargo
{

    private static final long serialVersionUID = -4891152555157705355L;
     ...
     */
    protected String selectedApprovalCodeString = utility.retrieveText("Common",BundleConstantsIfc.TILL_BUNDLE_NAME,"Unknown","Unknown");
    ...
    /**
     * Returns the amount set for the pay out.
    ...
    /**
     * Sets the amount for the pay out.
    ...
    {
        return RoleFunctionIfc.TILL_PAYOUT;
    }
    ...
    {
        selectedApprovalCodeString = value;
    }
    ...
    {
        return(selectedApprovalCodeString);
    }
