 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/till/tillloan/CheckCountLoanParameterErrorAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:18 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:27:56   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:29:04   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:18:32   msg
 * Initial revision.
 * 
...
//------------------------------------------------------------------------------
/**
    This aisle shows the Till Count Loan Parameter Error dialog.

    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class CheckCountLoanParameterErrorAisle extends PosLaneActionAdapter implements LaneActionIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 5587076048866423099L;
    ...
    //--------------------------------------------------------------------------
    /**
        Show the Till Count Loan Parameter Error dialog.
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        model.setResourceID("TillCountLoanParameterError");
