 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/startofday/SafeCountParamSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:22 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:29:20   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:15:36   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:28:14   msg
 * Initial revision.
 * 
 *    Rev 1.2   02 Mar 2002 12:47:50   pdd
...
{                                       // begin class SafeCountParamSite
    ...
    **/
    ...
    {                                   // begin arrive()
        ...
        try
        {
            value = pm.getStringValue("CountOperatingFundsAtStartOfDay");
            ...
            FinancialCountIfc exp = (FinancialCountIfc)ft.getStartingSafeCount().getExpected();
            ...
            {
                FinancialCountIfc ent = (FinancialCountIfc)ft.getStartingSafeCount().getEntered();
