 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/register/registeropen/OfflineOpenStoreLaunchShuttle.java /main/1 2014/07/23 15:44:28 rhaight Exp $
 * ===========================================================================
 * NOTES
...
**/
//--------------------------------------------------------------------------
public class OfflineOpenStoreLaunchShuttle extends OpenStoreLaunchShuttle
{
    /** Serial Version ID */
    private static final long serialVersionUID = -8481940266472474536L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.dailyoperations.register.registeropen.OfflineOpenStoreLaunchShuttle.class);
    ...
    **/
    ...
    protected EYSDate offineOpenDate = null;
    ...
    public void load(BusIfc bus)
    {
        ...
        offineOpenDate = cargo.getStoreStatus().getBusinessDate();
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        cargo.setInputBusinessDate(offineOpenDate);
