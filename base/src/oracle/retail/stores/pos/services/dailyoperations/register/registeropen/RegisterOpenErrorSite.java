 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/dailyoperations/register/registeropen/RegisterOpenErrorSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:16 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:17:34   msg
 * Initial revision.
 * 
...
//--------------------------------------------------------------------------
/**
    Displays register-is-already-open error message. <P>
...
public class RegisterOpenErrorSite extends PosSiteActionAdapter
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        model.setResourceID("RegisterAlreadyOpenError");
