 ...
 * 
 * @author nkgautam
 * @deprecated as of 14.0. Just use {@link IsSerialisationEnabledSignal} and use NEGATE element in tour.
 */
@SuppressWarnings("serial")
public class IsSerialisationDisabledSignal implements TrafficLightIfc
{
