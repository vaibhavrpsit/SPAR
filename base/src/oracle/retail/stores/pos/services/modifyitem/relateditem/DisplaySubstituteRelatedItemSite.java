...
* ===========================================================================
* $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/relateditem/DisplaySubstituteRelatedItemSite.java /main/1 2012/11/08 17:29:02 yiqzhao Exp $
* ===========================================================================
* NOTES
...
public class DisplaySubstituteRelatedItemSite extends DisplayRelatedItemSite
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
    	...
    	ui.showScreen(POSUIManagerIfc.SUBSTITUTE_RELATED_ITEMS, relatedItemListBeanModel);
    }
}