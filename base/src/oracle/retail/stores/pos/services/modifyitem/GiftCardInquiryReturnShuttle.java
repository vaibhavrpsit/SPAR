 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/GiftCardInquiryReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:24 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    in the gift card inquiry service to the cargo used in the modify item service. <p>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class GiftCardInquiryReturnShuttle implements ShuttleIfc
{                                       // begin class GiftCardInquiryReturnShuttle()
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -5845320044673605106L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.modifyitem.GiftCardInquiryReturnShuttle.class);
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Loads cargo from gift card inquiry service. <P>
       <B>Pre-Condition(s)</B>
       <UL>
       <LI>Cargo will contain the gift card
       </UL>
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Loads cargo for modify item service. <P>
       <B>Pre-Condition(s)</B>
       <UL>
       <LI>Cargo will contain the gift card
       </UL>
    ...
    **/
    ...
    {                                   // begin toString()
        // result string
        String strResult = new String("Class:  GiftCardInquiryReturnShuttle (Revision " +
                                      getRevisionNumber() +
                                      ") @" + hashCode());
        // pass back result
        return(strResult);
...
}                                       // end class GiftCardInquiryReturnShuttle
