 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/InquiryOptionsReturnShuttle.java /main/12 2012/10/04 09:56:50 hyin Exp $
 * ===========================================================================
 * NOTES
 ...
 * 
 *    Rev 1.0   Apr 29 2002 15:16:52   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:37:04   msg
 * Initial revision.
 * 
 ...
 * 
 *    Rev 1.1   25 Oct 2001 17:43:12   baa
...
**/
//--------------------------------------------------------------------------
public class InquiryOptionsReturnShuttle implements ShuttleIfc
{
    ...
    **/
    protected InquiryOptionsCargo inquiryCargo = null;
    ...
    **/
    ...
    {
        inquiryCargo = (InquiryOptionsCargo) bus.getCargo();
    }
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        PLUItemIfc item = inquiryCargo.getPLUItem();
        if (inquiryCargo.getModifiedFlag() && item != null)
        {
            cargo.setPLUItem(inquiryCargo.getPLUItem());
            cargo.setItemQuantity(inquiryCargo.getItemQuantity());
            cargo.setAddPLUItem(inquiryCargo.getModifiedFlag());
        ...
        else
        {
            ...
            {
                SaleReturnTransactionIfc transaction = (SaleReturnTransactionIfc)inquiryCargo.getTransaction();
    ...
    **/
    ...
    {                                   // begin main()
        // instantiate class
        InquiryOptionsReturnShuttle obj = new InquiryOptionsReturnShuttle();
