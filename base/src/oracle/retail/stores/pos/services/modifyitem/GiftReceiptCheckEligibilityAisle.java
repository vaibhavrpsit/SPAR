 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/GiftReceiptCheckEligibilityAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:25 mszekely Exp $
 * ===========================================================================
 * NOTES
...
{    
    ...
    public void traverse(BusIfc bus)
    {
        ...
        {
            if(lineItems[i].hasDamageDiscount())
            {
                itemCount++;
                if(filledSlots < 3)
                {
                    args[filledSlots] = lineItems[i].getItemDescription(LocaleMap.getLocale(LocaleConstantsIfc.USER_INTERFACE));
                    filledSlots++;
