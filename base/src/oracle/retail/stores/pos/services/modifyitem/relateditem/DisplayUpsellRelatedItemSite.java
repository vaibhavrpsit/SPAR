...
* ===========================================================================
* $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/modifyitem/relateditem/DisplayUpsellRelatedItemSite.java /main/1 2012/11/08 17:29:02 yiqzhao Exp $
* ===========================================================================
* NOTES
...
public class DisplayUpsellRelatedItemSite extends DisplayRelatedItemSite
{
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
    	...
    	ui.showScreen(POSUIManagerIfc.UPSELL_RELATED_ITEMS, relatedItemListBeanModel);
    }
}