 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/payment/IsRetailTransactionSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:14 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:20:08   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:35:28   msg
 * Initial revision.
 * 
...
//--------------------------------------------------------------------------
/**
    This signal checks to make sure that the transaction is a
    Retail Transaction.
    <p>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class IsRetailTransactionSignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 2643649261193811475L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.layaway.payment.IsRetailTransactionSignal.class);
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
       Checks to make sure that the transaction is a retail
       transaction.
       <P>
       @return true if the transaction is a retail transaction, false otherwise.
    **/
    //----------------------------------------------------------------------
    ...
    **/
    ...
    {                                   // begin toString()
        ...
        String strResult = new String("Class:  IsRetailTransactionSignal (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
        return(strResult);
    }                                   // end toString()
    ...
    **/
    ...
    {                                   // begin main()
        // instantiate class
        IsRetailTransactionSignal obj = new IsRetailTransactionSignal();
