 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/find/LayawayPickupAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:13 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:20:50   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:35:20   msg
 * Initial revision.
 * 
...
/**
    ...
    Layaway List screen, and presses Pickup.
    <p>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class LayawayPickupAisle extends LaneActionAdapter
{
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Stores the Pickup data operation to perform on the selected Layaway 
    ...
    **/                                          
    ...
    public void traverse(BusIfc bus)
    {
        ...
        // set the Pickup operation
        cargo.setLayawayOperation(FindLayawayCargoIfc.LAYAWAY_PICKUP);
