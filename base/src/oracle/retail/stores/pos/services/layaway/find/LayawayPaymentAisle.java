 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/layaway/find/LayawayPaymentAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:13 mszekely Exp $
 * ===========================================================================
 * NOTES
...
/**
    ...
    Layaway List screen, and presses Payment.
    <p>
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class LayawayPaymentAisle extends LaneActionAdapter
{
    /**
    ...
    **/
    ...
    //----------------------------------------------------------------------
    /**
        Stores the payment action to perform on the selected Layaway Summary 
        and mails a Success letter.
        <P> 
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setLayawayOperation(FindLayawayCargoIfc.LAYAWAY_PAYMENT);
