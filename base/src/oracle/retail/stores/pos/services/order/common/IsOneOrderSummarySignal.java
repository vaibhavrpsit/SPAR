 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/common/IsOneOrderSummarySignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:33 mszekely Exp $
 * ===========================================================================
 * NOTES
...
**/
//--------------------------------------------------------------------------
public class IsOneOrderSummarySignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 8679567568041070353L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.order.common.IsOneOrderSummarySignal.class);
    ...
    **/
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        {
            result = true;
            cargo.setSelectedSummary(cargo.getOrderSummaries()[0]); // get summary
        }
    ...
    **/
    ...
    {
        String strResult = new String("Class:  IsOneOrderSummarySignal (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
        return(strResult);
    }
