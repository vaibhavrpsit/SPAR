 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/ViewEnteredRoad.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:34 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * 
 *    Rev 1.1   Aug 22 2002 10:55:30   jriggins
 * Now attempting to pull service name from the bundle.
 * Resolution for POS SCR-1740: Code base Conversions
 * 
 *    Rev 1.0   Apr 29 2002 15:11:34   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:40:40   msg
 * Initial revision.
 * 
...
public class ViewEnteredRoad extends LaneActionAdapter
{
    /**
       class name constant
    **/
    public static final String LANENAME = "ViewEnteredRoad";
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setServiceType(OrderCargoIfc.SERVICE_VIEW_TYPE);
