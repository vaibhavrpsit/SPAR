 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/order/xchannelcreatepickup/RetrieveStoreByCriteriaAisle.java /main/3 2013/01/07 13:42:31 hyin Exp $
 * ===========================================================================
 * NOTES
 ...
 *    hyin      01/03/13 - add store search web service to commExt.
 *    hyin      01/03/13 - using store search service.
...
public class RetrieveStoreByCriteriaAisle extends PosLaneActionAdapter
{
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        DataInputBeanModel model = (DataInputBeanModel)ui.getModel(POSUIManagerIfc.STORE_SEARCH_FOR_ORDER);
        ...
        try
        {
            ...
            else
            {
                ...
                cargo.resetLineItemIndex();
                cargo.setListFromStoreGroup(false);
