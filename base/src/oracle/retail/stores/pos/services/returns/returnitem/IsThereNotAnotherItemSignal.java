 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/IsThereNotAnotherItemSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:56 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   05 Feb 2004 23:24:10   baa
 * Initial revision.
 * 
 *    Rev 1.0   Aug 29 2003 16:06:24   CSchellenger
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:04:26   msg
 * Initial revision.
 * 
 *    Rev 1.0   Mar 18 2002 11:46:38   msg
 * Initial revision.
 * 
 *    Rev 1.2   22 Feb 2002 18:03:28   cir
 ...
 * 
 *    Rev 1.1   20 Feb 2002 16:32:54   cir
 * Check for non returnable gift card
 * Resolution for POS SCR-671: Gift card - multiple item return with expended gift card error
 *
 *    Rev 1.0   Sep 21 2001 11:25:50   msg
 * Initial revision.
 *
...
//--------------------------------------------------------------------------
/**
     This returns true if there are no more items to return for the current
     transaction.
     <P>
     @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//--------------------------------------------------------------------------
public class IsThereNotAnotherItemSignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -1449864637560723357L;
    ...
    **/
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        {
            itemListSize = cargo.getReturnSaleLineItems().length;
        }
        boolean notAnotherItem = false;
        if (nextItem > 0 || nextItem < (itemListSize))
        {
            notAnotherItem = true;
        }


        return notAnotherItem;
    }
