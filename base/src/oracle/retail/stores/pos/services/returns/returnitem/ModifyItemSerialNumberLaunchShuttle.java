 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnitem/ModifyItemSerialNumberLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:56 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class ModifyItemSerialNumberLaunchShuttle extends FinancialCargoShuttle
{
    ...
    /** serialVersionUID */
    private static final long serialVersionUID = -7666050944936562517L;
    
    /** 
     * Item Return Cargo
     */
    protected ReturnItemCargoIfc returnCargo = null;
    ...
    **/
    ...
    {
        super.load(bus);
        returnCargo = (ReturnItemCargoIfc)bus.getCargo();
    }
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        srli.setPLUItem(returnCargo.getPLUItem());
