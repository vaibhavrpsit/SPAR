 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returnfindorder/OrderSearchLaunchShuttle.java /main/2 2013/05/01 10:33:34 jswan Exp $
 * ===========================================================================
 * NOTES
...
**/
//--------------------------------------------------------------------------
public class OrderSearchLaunchShuttle extends FinancialCargoShuttle
{
    /** serialVersionUID */
    ...
    **/
    protected static Logger logger = Logger.getLogger(OrderSearchLaunchShuttle.class);
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        cargo.setReadOrderFromSummary(true);
        cargo.setRetrieveForReturn(true);
    }
}
