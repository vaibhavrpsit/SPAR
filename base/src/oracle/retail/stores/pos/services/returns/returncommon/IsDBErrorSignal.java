 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returncommon/IsDBErrorSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:58 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:06:40   msg
 * Initial revision.
 * 
...
{
    static final long serialVersionUID = 1886513468743037998L;
     ...
     * signal name
     */
    public static final String SIGNALNAME = "IsDBErrorSignal";
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        {
            // reset the error to NONE; this way the next time through
            // this code the correct signal will return true.
    ...
    { // begin toString()
        String strResult = new String("Class:  " + SIGNALNAME + " (Revision " + getRevisionNumber() + ")" + hashCode());
