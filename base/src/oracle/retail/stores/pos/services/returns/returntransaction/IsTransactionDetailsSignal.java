 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/returns/returntransaction/IsTransactionDetailsSignal.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:57 mszekely Exp $
 * ===========================================================================
 * NOTES
...
**/
//--------------------------------------------------------------------------
public class IsTransactionDetailsSignal implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 2885184649871888620L;
    ...
    **/
    ...
    /**
       ...
       @return true if functionid is display transaction details; false otherwise
    **/
    //--------------------------------------------------------------------------
    public boolean roadClear(BusIfc bus)
    {
        ...
        boolean isTransDetailAccess = false;
        
        if ( functionID == RoleFunctionIfc.DISPLAY_TRANSACTION_DETAILS)
        {
            isTransDetailAccess = true;
        }

        return isTransDetailAccess;
    }
