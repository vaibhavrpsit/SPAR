 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/employee/employeeadd/EmployeeAddStandardAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:08 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 * Rev 1.2 19 Jan 2004 12:50:52 Tim Fritz Employee data is now being reset.
 * 
 * Rev 1.1 Dec 16 2003 15:25:54 jriggins Making use of the EmployeeTypeEnum
...
public class EmployeeAddStandardAisle
    ...
    implements LaneActionIfc
{
    ...
    //
    static final long serialVersionUID = -8480873877544451529L;
    ...
    public void traverse(BusIfc bus)
    {
        ...
        cargo.setAddEmployeeType(EmployeeTypeEnum.STANDARD);

        // When entering the Employee master screen from the
        // add options screen employee data should be
