 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/employeediscount/ModifyEmployeeTransactionDiscountPercentReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 16:17:09 mszekely Exp $
 * ===========================================================================
 * NOTES
...
import oracle.retail.stores.pos.services.pricing.ModifyTransactionDiscountPercentReturnShuttle;
...
**/
//--------------------------------------------------------------------------
public class ModifyEmployeeTransactionDiscountPercentReturnShuttle
    extends ModifyTransactionDiscountPercentReturnShuttle
{
    /**
