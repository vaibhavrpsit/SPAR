 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/ItemDiscountReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:01 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.1   Oct 17 2003 10:24:56   bwf
...
public class ItemDiscountReturnShuttle extends FinancialCargoShuttle
{
    ...
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.pricing.ItemDiscountReturnShuttle.class);
