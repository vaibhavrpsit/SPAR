 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/pricing/MarkdownLaunchShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:00 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 * 
 *    Rev 1.0   Aug 29 2003 16:05:14   CSchellenger
 * Initial revision.
 * 
 *    Rev 1.1   Jul 11 2003 11:28:42   baa
 * add security access check for price override, markdowns and item discounts
 * Resolution for 3138: The Manager Override screen is not presented when a user with no access selects the Item Markdown Amount button.
 * Resolution for 3139: The Manager Override screen is not presented when a user with no access selects the Item Markdown Percent button.
 * Resolution for 3141: The Manager Override screen is not presented when a user with no access selects the Item Markdown % button.
 * 
 *    Rev 1.0   05 Jun 2002 17:32:46   jbp
 * Initial revision.
...
**/
//------------------------------------------------------------------------------
public class MarkdownLaunchShuttle extends FinancialCargoShuttle
{
    /** The logger to which log messages will be sent. **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.pricing.MarkdownLaunchShuttle.class);
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        pc.setAccessFunctionID(RoleFunctionIfc.MODIFY_MARKDOWNS);
    }
