 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/role/RoleEditReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:06 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:37:38   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:07:08   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:20:54   msg
 * Initial revision.
 * 
...
/**
    ...
    RoleEdit cargo to the shuttle, and then from the
    shuttle to the RoleMain cargo.
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class RoleEditReturnShuttle implements ShuttleIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -5512854128192818414L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.admin.role.RoleEditReturnShuttle.class);
    ...
    **/
    public static final String SHUTTLENAME = "RoleEditReturnShuttle";
    ...
    **/
    ...
    {
        // result string
        String strResult = new String("Class: RoleEditReturnShuttle"
