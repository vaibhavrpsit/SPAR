 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/CurrencyParamLight.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:39:06   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:04:10   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:19:08   msg
 * Initial revision.
 * 
...
public class CurrencyParamLight implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 9203634200895755658L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.admin.parametermanager.CurrencyParamLight.class);


    public static final String SIGNALNAME = "CurrencyParamLight";
