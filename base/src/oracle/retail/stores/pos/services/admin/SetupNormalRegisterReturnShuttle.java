 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/SetupNormalRegisterReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:04 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
 * $Log:
 *    1    360Commerce 1.0         11/22/2007 10:57:20 PM Naveen Ganesh   
 *
...
public class SetupNormalRegisterReturnShuttle implements ShuttleIfc
{
    ...
    **/
    ...
    {
        AdminCargo adminCargo = (AdminCargo) bus.getCargo();

        RegisterADO registerADO = adminCargo.getRegisterADO();
        RegisterIfc register = fromCargo.getRegister();
        if (adminCargo.isTrainingMode())
        {
        ...
        adminCargo.setTenderLimits(fromCargo.getTenderLimits());
    }
}
