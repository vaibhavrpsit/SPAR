 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/DiscreteParamLight.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:06 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:04:16   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:19:12   msg
 * Initial revision.
 * 
 *    Rev 1.1   30 Jan 2002 10:18:06   KAC
 * Now considers whether there might be a "list from list"
 * situation.
 * Resolution for POS SCR-672: Create List Parameter Editor
 * 
 *    Rev 1.0   Sep 21 2001 11:11:30   msg
 * Initial revision.
 * 
...
public class DiscreteParamLight implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -7159382684824856491L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.admin.parametermanager.DiscreteParamLight.class);


    public static final String SIGNALNAME = "DiscreteParamLight";

    //--------------------------------------------------------------------------
    /**
       roadClear determines whether it is safe for the bus to proceed
       @param bus the bus trying to proceed
       @return true if the parameter in the cargo has one of a set
       of discrete values and is modifiable; false otherwise
    **/
    //--------------------------------------------------------------------------
    ...
    public boolean roadClear(BusIfc bus)
    {
        ...
        boolean isGreen =
            (parameter instanceof DiscreteParameterBeanModel)
            && !(parameter instanceof ListFromListParameterBeanModel)
