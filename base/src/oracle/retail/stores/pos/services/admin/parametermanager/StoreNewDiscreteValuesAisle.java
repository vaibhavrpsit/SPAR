 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/StoreNewDiscreteValuesAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:05:20   msg
 * - updated copyright
 * 
...
**/
//------------------------------------------------------------------------------
public class StoreNewDiscreteValuesAisle extends LaneActionAdapter
{
    /** revision number **/
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        DiscreteParameterBeanModel model = (DiscreteParameterBeanModel)ui.getModel(POSUIManagerIfc.PARAM_EDIT_DISCRETE);
        String newValue = (String)model.getNewValue();
        ...
        if (cargoParam instanceof DiscreteParameterBeanModel)
        {
            DiscreteParameterBeanModel discreteParam = (DiscreteParameterBeanModel)cargoParam;
            discreteParam.setModifiableValue(newModifiable);
            discreteParam.setValue(newValue);

            try
            {
                cargo.convertBeanToParameter(discreteParam);
            }
