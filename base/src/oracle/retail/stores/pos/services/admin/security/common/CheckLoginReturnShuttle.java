 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/security/common/CheckLoginReturnShuttle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:07 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *
 *
 *    Rev 1.0   Oct 17 2003 12:53:40   epd
 * Initial revision.
 *
...
**/
//------------------------------------------------------------------------------
public class CheckLoginReturnShuttle implements ShuttleIfc
{                                       // begin class OperatorIdReturnShuttle
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = -2890461943508180046L;

    /**
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.admin.security.common.CheckLoginReturnShuttle.class);
    /**
    ...
    **/
    ...
    public void unload(BusIfc bus)
    {
        ...
        callingCargo.setOverrideOperator(opIDCargo.getSelectedEmployee());
