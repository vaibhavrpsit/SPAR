 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/ModifiableParamLight.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:04:56   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:19:44   msg
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:11:46   msg
 * Initial revision.
 * 
...
public class ModifiableParamLight implements TrafficLightIfc
{
    // This id is used to tell
    // the compiler not to generate a
    // new serialVersionUID.
    //
    static final long serialVersionUID = 2989657978573472268L;

    /** 
        The logger to which log messages will be sent.
    **/
    protected static Logger logger = Logger.getLogger(oracle.retail.stores.pos.services.admin.parametermanager.ModifiableParamLight.class);


    public static final String SIGNALNAME = "ModifiableParamLight";
