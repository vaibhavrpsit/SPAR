 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/queue/ClearQueueSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:08 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *    aariyer   04/22/09 - For the Clear Queue Exception in POS
 *
 * ===========================================================================
 * $Log:
...
**/
//------------------------------------------------------------------------------
public class ClearQueueSite extends PosSiteActionAdapter
{                                       // begin class DisplayTillOptionSite

    /**
       site name constant
    **/
    public static final String SITENAME = "ClearQueueSite";
    /**
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
      ...
      String[] qNames = dm.getQueueNames();
      ...
      for(int i = 0; i < qNames.length; i++)
      {
          ...
          DataTransactionQueueIfc queue = dm.getTransactionQueue(qNames[0]);
          queue.clearQueue();
      }

      // Set up the dialog model
      model.setResourceID("AcknowledgeClearQueue");
