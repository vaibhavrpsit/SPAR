 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/queue/ConfirmDeleteSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:08 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * 
 *    Rev 1.0   Aug 29 2003 15:53:12   CSchellenger
 * Initial revision.
 * 
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Sep 21 2001 11:12:26   msg
 * Initial revision.
 * 
...
//------------------------------------------------------------------------------
/**
    This site displays the Confirm Queue Delete screen.
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class ConfirmDeleteSite extends PosSiteActionAdapter
{                                       // begin class DisplayTillOptionSite

    /**
       site name constant
    **/
    public static final String SITENAME = "ConfirmDeleteSite";
    /**
    ...
    **/
    ...
    {                                   // begin arrive()
        ...
        model.setResourceID("ConfirmDeleteFirstQueueEntry");
