 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/StoreNewListFromListValuesAisle.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:39:38   msg
 * Initial revision.
 * 
...
**/
//------------------------------------------------------------------------------
public class StoreNewListFromListValuesAisle extends LaneActionAdapter
{
    /** revision number **/
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
        ...
        ListFromListParameterBeanModel model = (ListFromListParameterBeanModel)
            ui.getModel(POSUIManagerIfc.PARAM_EDIT_LIST_FROM_LIST);
        Serializable[] newValuesArray = model.getNewValues();

        ParameterCargo cargo = (ParameterCargo)bus.getCargo();
        RetailParameter cargoParam = cargo.getParameter();

        if (cargoParam instanceof ListFromListParameterBeanModel)
        {
            ListFromListParameterBeanModel listFromListParam =
                (ListFromListParameterBeanModel)cargoParam;
            listFromListParam.setNewValues(newValuesArray);

            try
            {
                cargo.convertBeanToParameter(listFromListParam);
            }
