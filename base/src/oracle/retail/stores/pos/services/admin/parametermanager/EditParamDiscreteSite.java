 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/admin/parametermanager/EditParamDiscreteSite.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:05 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.0   Apr 29 2002 15:39:14   msg
 * Initial revision.
 * 
 *    Rev 1.1   Mar 18 2002 23:04:22   msg
 * - updated copyright
 * 
 *    Rev 1.0   Mar 18 2002 11:19:14   msg
 * Initial revision.
 * 
...
//------------------------------------------------------------------------------
/**
    Edit a parameter whose value can be one of a discrete set of values.
    @version $Revision: /rgbustores_13.4x_generic_branch/1 $
**/
//------------------------------------------------------------------------------
public class EditParamDiscreteSite extends PosSiteActionAdapter
{
    /** revision number **/
    ...
    //--------------------------------------------------------------------------
    /**
        Sets up the UI to edit a parameter whose value can be one of a discrete
        set of values. <p>
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        ui.showScreen(POSUIManagerIfc.PARAM_EDIT_DISCRETE, beanModel);
    }
}
