 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/SetRequestTypeDebitAuthRefundRoad.java /rgbustores_13.4x_generic_branch/3 2011/10/17 14:55:57 sgu Exp $
 * ===========================================================================
 * NOTES
 ...
 *    blarsen   09/27/11 - Changing request type to AuthorizeCardRefund. This
 *                         prevents the PinComm card type inquiry prompt to
 *                         customer.
 *
 * ===========================================================================
 */
...
public class SetRequestTypeDebitAuthRefundRoad extends LaneActionAdapter
{
