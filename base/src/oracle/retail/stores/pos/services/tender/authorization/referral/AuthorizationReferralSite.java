 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/tender/authorization/referral/AuthorizationReferralSite.java /main/1 2012/09/12 11:57:17 blarsen Exp $
 * ===========================================================================
 * NOTES
...
public class AuthorizationReferralSite extends PosSiteActionAdapter
{
    ...
    public void arrive(BusIfc bus)
    {
        ...
        CreditReferralBeanModel beanModel = authorizationCargo.getCreditReferralBeanModel();
        if(beanModel == null)
        {
            beanModel = new CreditReferralBeanModel();
        }
