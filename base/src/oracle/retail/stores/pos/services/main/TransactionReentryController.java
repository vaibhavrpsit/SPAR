 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/services/main/TransactionReentryController.java /main/13 2012/09/12 11:57:10 blarsen Exp $
 * ===========================================================================
 * NOTES
...
//        StringBuffer sb =
//            new StringBuffer().append(Util.EOL).append(journalPrefix).append(" ").append(JOURNAL_TEXT).append(Util.EOL);
