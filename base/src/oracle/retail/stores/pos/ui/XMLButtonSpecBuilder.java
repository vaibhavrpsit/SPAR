 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/XMLButtonSpecBuilder.java /main/11 2012/10/16 17:37:28 cgreene Exp $
 * ===========================================================================
 * NOTES
...
public class XMLButtonSpecBuilder extends XMLBuilder implements BuilderIfc
{
    ...
    {
        StringBuilder tmpString = new StringBuilder("XMLButtonSpecBuilder@");
