 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/OrderListTableModel.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:39 mszekely Exp $
 * ===========================================================================
 * NOTES
...
public class OrderListTableModel extends AbstractTableModel
{
    ...
    //
    static final long serialVersionUID = 7449473814056471888L;

    /**
        revision number supplied by Team Connection
    **/
    public static final String revisionNumber = "$KW=@(#); $Ver=f3028:1; $EKW;";

    /**
        constant for class name
    **/
    public static final String CLASSNAME = "OrderListTableModel";
    ...
    **/
    //---------------------------------------------------------------------
    public OrderListTableModel(String[] columnName, int rowSize)
    {
        rows = rowSize;
    ...
    **/
    //---------------------------------------------------------------------
    public OrderListTableModel(int rowSize, int columnSize)
    {
        rows = rowSize;
        columns = columnSize;
        data = new Object[rows][columns];
    ...
    **/
    //---------------------------------------------------------------------
    public OrderListTableModel(Object[][] values)
    {
        data = new Object[rows][columns];
