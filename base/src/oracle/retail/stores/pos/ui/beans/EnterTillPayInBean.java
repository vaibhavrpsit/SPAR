 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/EnterTillPayInBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:57 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * ===========================================================================
 * $Log:
 *    7    360Commerce 1.6         3/29/2007 2:12:23 PM   Michael Boyd    v8x
 *         merge to trunk
 *
 *         6    .v8x      1.4.1.0     3/9/2007 1:04:11 PM    Brett J. Larsen
 *         CR         4530
 *         - when a default reason code is designated, it is not being
 *         displayed
 *
 *         added code to display the default (newly added to model)
 *
 *
 *    6    360Commerce 1.5         2/6/2007 2:49:39 PM    Edward B. Thorne
 *         Merge from EnterTillPayInBean.java, Revision 1.3.1.0
 *    5    360Commerce 1.4         12/14/2006 4:03:47 PM  Charles D. Baker CR
 *         20208 - merged fixes from 7.2.2 for till pay in, pay out behaviors.
 *    4    360Commerce 1.3         7/28/2006 6:06:26 PM   Brett J. Larsen CR
 ...
 *
 *
 *    4    .v7x      1.2.1.0     6/23/2006 4:54:17 AM   Dinesh Gautam   CR
...
**/
//----------------------------------------------------------------------------
public class EnterTillPayInBean extends ValidatingBean
{
    /**
        Revision number.
    */
    ...
    protected EnterTillPayInBeanModel beanModel
                                       = new EnterTillPayInBeanModel();
    ...
    */
    ...
    public void setModel(UIModelIfc model)
    {
        ...
        if (model instanceof EnterTillPayInBeanModel)
        {
            beanModel = (EnterTillPayInBeanModel)model;
            updateBean();
        }
    }
...
//    }
    ...
    protected void updateBean()
    {
        ...
        Vector<String> reasonCodes = beanModel.getReasonCodes();
        if (reasonCodes != null)
        {
            reasonCodeField.setModel(new ValidatingComboBoxModel(reasonCodes));

            int index = -1;
            setComboBoxModel(reasonCodes, reasonCodeField, index);
            ...
            {
                reasonCodeField.setSelectedItem(UIUtilities.retrieveCommonText(beanModel.getDefaultValue()));
            }
