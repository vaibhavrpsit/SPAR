 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ui/beans/SpecialOrderListBean.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:06:49 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 * Initial revision.
 * 
 *    Rev 1.1   Aug 14 2002 18:18:46   baa
 * format currency 
...
//------------------------------------------------------------------------------
/**
 *  This bean is used for displaying the Select Special Order list.
 */
//------------------------------------------------------------------------------
public class SpecialOrderListBean extends SimpleListBean
{
 ...
 */
    protected JPanel getHeaderBean()
    {
        ...
        if(headerBean == null)
        {
            headerBean = new SpecialOrderListHeader();
        }
        return headerBean;
    }
 ...
 */
    protected ListCellRenderer getRenderer()
    {
        ...
        if(renderer == null)
        {
            renderer = new SpecialOrderListRenderer();
        }
        return renderer;
    }
 ...
 */
    ...
    {
        SpecialOrderListBeanModel m = 
            (SpecialOrderListBeanModel)model;   
            
        Object[] newList = m.getOrderList();  
 ...
 */
    ...
    {
        ((SpecialOrderListBeanModel)model).setSelectedRow(list.getSelectedIndex());
    }
 ...
 */
    public static void main(String[] args)
    {
        ...
        SpecialOrderListBean bean = new SpecialOrderListBean();
        bean.configure();
