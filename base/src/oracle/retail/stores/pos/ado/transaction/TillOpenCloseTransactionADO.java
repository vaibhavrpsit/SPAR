 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/transaction/TillOpenCloseTransactionADO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:41 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *  
 */
public class TillOpenCloseTransactionADO extends AbstractRetailTransactionADO
{
    /** Our RDO transaction */
    protected TillOpenCloseTransactionIfc transactionRDO;
    ...
    {
        transactionRDO = DomainGateway.getFactory().getTillOpenCloseTransactionInstance();
    ...
    {
        transactionRDO = (TillOpenCloseTransactionIfc)rdo;
    }
}
