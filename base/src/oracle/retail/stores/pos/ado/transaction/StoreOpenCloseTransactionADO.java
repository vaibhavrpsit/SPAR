 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/src/oracle/retail/stores/pos/ado/transaction/StoreOpenCloseTransactionADO.java /rgbustores_13.4x_generic_branch/1 2011/05/05 14:05:41 mszekely Exp $
 * ===========================================================================
 * NOTES
 ...
 *  
 */
public class StoreOpenCloseTransactionADO extends AbstractRetailTransactionADO
{
    /** our RDO transaction */
    protected StoreOpenCloseTransactionIfc transactionRDO;
    ...
    {
        transactionRDO = DomainGateway.getFactory().getStoreOpenCloseTransactionInstance();
    ...
    {
        transactionRDO = (StoreOpenCloseTransactionIfc)rdo;
    }
}
