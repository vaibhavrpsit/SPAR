 ...
 * ===========================================================================
 * $Header: rgbustores/applications/pos/deploy/client/receipts/printing/templates/xsl/ipp_swan_receipt.xsl /main/2 2012/06/12 09:04:07 mchellap Exp $
 * ===========================================================================
 * NOTES
    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="sequence-of-pages" initial-page-number="1">        
          ...
          <fo:block-container 
                ...
                color="rgb(52,52,52)"     
                border-top="2pt rgb(163,190,216) outset"
                border-bottom="2pt rgb(163,190,216) outset"
                border-left="2pt rgb(163,190,216) outset"
                border-right="2pt rgb(163,190,216) outset">
