...
public class TenderFormatter implements RegisterJournalFormatterIfc
{
    ...
    protected void formatTender(JournalTemplateIfc template, JournalableADOIfc journalable, StringBuilder sb)
    {
        ...
        else  if (tender.getTenderType() == MAXTenderTypeEnum.PAYTM)
        {
            formatPaytmInfo(template, journalable, sb);
        }
 
        else  if (tender.getTenderType() == MAXTenderTypeEnum.MOBIKWIK)
        {
            formatMobikwikInfo(template, journalable, sb);
        }
        
        else  if (tender.getTenderType() == MAXTenderTypeEnum.AMAZON_PAY)
        {
        	formatAmazonPayInfo(template, journalable, sb);
        }
     ...
     */
    // Changes Start by Bhanu Priya 
    protected void formatPaytmInfo(JournalTemplateIfc template, JournalableADOIfc journalable, StringBuilder sb)
    {
        Map<String,Object> memento = journalable.getJournalMemento();
        Object [] dataArgs;
        // journal store credit ID
     ///  dataArgs = new Object[]{memento.get(TenderConstants.PHONE_NUMBER)};
        String args= (String)memento.get(TenderConstants.NUMBER);
        //memento.get
        dataArgs = new Object[]{args};
        
        sb.append(Util.EOL);
        sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.PHONE_NUMBER_LABEL,dataArgs,journalLocale));

    }

    protected void formatMobikwikInfo(JournalTemplateIfc template, JournalableADOIfc journalable, StringBuilder sb)
    {
        Map<String,Object> memento = journalable.getJournalMemento();
        Object [] dataArgs;
        // journal store credit ID
    ...
    protected void formatAmazonPayInfo(JournalTemplateIfc template, JournalableADOIfc journalable, StringBuilder sb)
    {
        Map<String,Object> memento = journalable.getJournalMemento();
        Object [] dataArgs;
        Object [] dataArgsAuthCode;
        // journal store credit ID
     ///  dataArgs = new Object[]{memento.get(TenderConstants.PHONE_NUMBER)};
        String args= (String)memento.get(TenderConstants.NUMBER);
        String authCode= (String) memento.get(MAXTenderConstants.AUTH_CODE);
        //memento.get
        dataArgs = new Object[]{args};
        dataArgsAuthCode= new Object[]{authCode};
        sb.append(Util.EOL);
        sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE, JournalConstantsIfc.PHONE_NUMBER_LABEL,dataArgs,journalLocale));
        sb.append(Util.EOL);
        sb.append(I18NHelper.getString(I18NConstantsIfc.EJOURNAL_TYPE,"JournalEntry.AuthCode",dataArgsAuthCode,journalLocale));
