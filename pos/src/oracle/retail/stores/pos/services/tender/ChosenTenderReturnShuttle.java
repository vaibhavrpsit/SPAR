...
public class ChosenTenderReturnShuttle implements ShuttleIfc
{
    ...
    public void unload(BusIfc bus)
    {
        ...
        //callingCargo.getTransaction().getTenderTransactionTotals().setBalanceDue(childCargo.getTransaction().getTenderTransactionTotals().getSubtotal());
        if(childCargo instanceof MAXTenderCargo)
        {
        if(((MAXTenderCargo)callingCargo).getCouponName()!=null)
       {
    	   ((MAXTenderCargo)callingCargo).setCouponName(((MAXTenderCargo)childCargo).getCouponName());
       }
        }   //System.out.println("101========"+((MAXTenderCargo)childCargo).getCouponName());
        //System.out.println("MAXChosenTenderSubTourLaunchShuttle :"+childCargo.getCurrentTransactionADO().getBalanceDue());
    }
}