...
public class MAXTenderEComCODADO extends AbstractTenderADO{
	...
	public MAXTenderEComCODADO()
	{
		//TO - DO
	}
	
	protected void initializeTenderRDO() {
        tenderRDO = ((MAXDomainObjectFactory)DomainGateway.getFactory()).getTenderEComCODInstance();
	}
	...
	public void fromLegacy(EYSDomainIfc rdo) {
		// TODO Auto-generated method stub
		tenderRDO = (MAXTenderEComCODIfc)rdo;
	}
