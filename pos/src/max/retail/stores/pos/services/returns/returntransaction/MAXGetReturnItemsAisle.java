 ...
 * ===========================================================================
 */
package max.retail.stores.pos.services.returns.returntransaction;
 ...
 */
//--------------------------------------------------------------------------
public class MAXGetReturnItemsAisle extends ValidateItemNumberAisle
{
    /** serialVersionUID */
    ...
    public void traverse(BusIfc bus)
    {
       ...
       // String itemID = promptModel.getResponseText();
        ...
        // PAN Changes starts 
        MAXSaleReturnTransactionIfc orgTransaction = (MAXSaleReturnTransactionIfc) cargo.getOriginalTransaction();
        MAXSaleReturnTransactionIfc CurrentTransaction = (MAXSaleReturnTransactionIfc) cargo.getTransaction();
        if(orgTransaction.getPanNumber()!=null) {
        	CurrentTransaction.setPanNumber(orgTransaction.getPanNumber());
        }
        if(orgTransaction.getForm60IDNumber()!=null){
        	CurrentTransaction.setForm60IDNumber(orgTransaction.getForm60IDNumber());
        }
        if(orgTransaction.getPassportNumber()!= null){
        	CurrentTransaction.setPassportNumber(orgTransaction.getPassportNumber());
        }
     // PAN Changes Ends 
