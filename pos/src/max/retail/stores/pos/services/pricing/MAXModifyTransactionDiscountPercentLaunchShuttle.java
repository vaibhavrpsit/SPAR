...
**/
//--------------------------------------------------------------------------
public class MAXModifyTransactionDiscountPercentLaunchShuttle extends FinancialCargoShuttle
{
    /**
	 * 
	 */
	private static final long serialVersionUID = 4089494481987548446L;
...
//                                                  transaction.getSalesAssociate();
      ...
      //changes for manageroverride start
		...
		/*
		 * RetailTransactionIfc trans =cargo.getTransaction(); MAXManagerOverride mgo=
		 * new MAXManagerOverride();
		 * mgo.setBusinessDay(cargo.getTransaction().getBusinessDay());
		 * mgo.setStoreCreditId(null); mgo.setFeatureId("251"); mgo.setItemId(null);
