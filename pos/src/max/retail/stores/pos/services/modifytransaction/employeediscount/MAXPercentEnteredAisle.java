...
package max.retail.stores.pos.services.modifytransaction.employeediscount;
...
public class MAXPercentEnteredAisle extends PercentEnteredAisle {
	...
	public void traverse(BusIfc bus) {
		...
		System.out.println("71 MAXPercentEnteredAisle================");
		...
		if (cargo.isEmployeeRemoveSelected() && (cargo.getEmployeeDiscountID() != null) && cargo.getDiscount() != null) {
			...
			empDiscParameter=companyName.concat("LandmarkEmployeeDiscountAmountPercent");
