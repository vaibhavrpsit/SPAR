...
**/
//--------------------------------------------------------------------------
public class IsNotScanAndVoidSignal implements TrafficLightIfc
{
    /**
	 * 
	 */
    ...
    **/
     ...
     **/
    private static Logger logger = Logger.getLogger(max.retail.stores.pos.services.sale.IsNotScanAndVoidSignal.class);
   
    public boolean roadClear(BusIfc bus)
    {
    	if (logger.isDebugEnabled()) logger.debug("IsNotScanAndVoidSignal.roadClear()");
    ...
    **/
    ...
    {
        String strResult = new String("Class:  IsNotScanAndVoidSignal (Revision " +
                                      getRevisionNumber() +
                                      ")" + hashCode());
        return(strResult);
    }
