...
public class MAXOrderSendMethodSelectedRoad extends PosLaneActionAdapter
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -4260826018567548845L;
	/**
    ...
    **/
     ...
     */
    private static Logger logger = Logger.getLogger(max.retail.stores.pos.services.order.pickup.displaysendmethod.MAXOrderSendMethodSelectedRoad.class);
    /**
    ...
    **/
    ...
    public void traverse(BusIfc bus)
    {
       ...
       MAXOrderShippingMethodBeanModel model = (MAXOrderShippingMethodBeanModel) ui.getModel();
       MAXOrderTransaction transaction = (MAXOrderTransaction)cargo.getTransaction();
       ...
       else
       {
           ...
           for (int i = 0; i < items.length; i++)
           {
               ...
               items[i].setSendLabelCount(((MAXTransactionTotalsIfc) totals).getItemSendPackagesCount());
           }
       }
