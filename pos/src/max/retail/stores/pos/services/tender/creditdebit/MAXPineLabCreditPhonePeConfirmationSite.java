...
public class MAXPineLabCreditPhonePeConfirmationSite extends PosSiteActionAdapter
{
	...
	public void arrive(BusIfc bus)
	{
		...
		if(cargo.getCustomer() instanceof MAXCustomerIfc && cargo.getCustomer() !=null){
			...
			//customer.getContact().getPhoneList().toString();
		...
		if(bus.getCurrentLetter().getName().equals(CommonLetterIfc.UNDO) && mobile !=null && !mobile.equals("")) {
			...
			dialogModel.setResourceID("PhonePeConfirmation");
