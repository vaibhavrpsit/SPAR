...
//--------------------------------------------------------------------------
/**
 * This class displays the credit confirmation site. $Revision: 1.2 $
 **/
// --------------------------------------------------------------------------
public class MAXPineLabCreditConfirmationUISite extends PosSiteActionAdapter {
	/**
	 * 
	 */
	...
	public void arrive(BusIfc bus) {
		...
		try {
			...
			String message = utility.retrieveCommonText("creditConfirmation", "Authorize Charge Amount:\n {0}\n Credit Card # {1}");
			...
			if (pda.isMSROnline().equals(Boolean.TRUE)) {
