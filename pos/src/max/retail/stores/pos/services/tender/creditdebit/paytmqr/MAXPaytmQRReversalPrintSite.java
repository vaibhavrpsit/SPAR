 ...
 * Rev 1.0 		March 30, 2022    Kamlesh Pant   Paytm QR Integration
 * Initial revision.
 * 
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
public class MAXPaytmQRReversalPrintSite extends PosSiteActionAdapter{
	...
	public void arrive(BusIfc bus)
	{
		...
		try
		{
			printPaytmSlip(bus, cargo.getPaytmQRCodeResp(),  cargo.getTransaction());
		}
		catch(PrintableDocumentException e)
		{
			StatusBeanModel statusModel = new StatusBeanModel();
			mailLetter = false;
            logger.error("Unable to print Paytm Reversal Receipt ", e);
	...
	public void printPaytmSlip(BusIfc bus, MAXPaytmQRCodeResponse paytmResponse, TenderableTransactionIfc trans) throws ParameterException,PrintableDocumentException {
		...
		//receipt.setDocumentType(MAXReceiptTypeConstantsIfc.PAYTMQRREFUNDSLIP);
