...
public class MAXPaytmReversalPrintSite extends PosSiteActionAdapter{
	...
	public void arrive(BusIfc bus)
	{
		...
		try
		{
			printPaytmSlip(bus, cargo.getPaytmResp(),  cargo.getTransaction());
		}
	...
	public void printPaytmSlip(BusIfc bus, MAXPaytmResponse paytmResponse, TenderableTransactionIfc trans) throws ParameterException,PrintableDocumentException 
	{
		...
		receipt.setDocumentType(MAXReceiptTypeConstantsIfc.PAYTMREFUNDSLIP);
