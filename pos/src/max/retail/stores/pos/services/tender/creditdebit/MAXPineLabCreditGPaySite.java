...
public class MAXPineLabCreditGPaySite extends PosSiteActionAdapter {
		...
		try {
			String mobile=null;
			 POSBaseBeanModel model = (POSBaseBeanModel)ui.getModel(MAXPOSUIManagerIfc.ENTER_GPAY_NUMBER);
				...
				ui.showScreen(MAXPOSUIManagerIfc.EDC_POST_VOID_GPAY_SCREEN, beanModel);
			/*
			...
			responseMap = edcObj.makePostVoidEDC(txnNumber, amountString,
					invoiceNumber, transactionTime, "00", "17");								
			...
			if (responseMap != null) {
				...
				if (hostResponseCode.equals("00")) {
					...
					try {
						...
						// MAX Change for Rev 1.1: Start
						if(schemeType!=null && schemeType.equalsIgnoreCase("GPAY") && responseMap.get("HostResponseRetrievelRefNumber")!=null){
					...
					showDialogBoxMethod(responseMap, bus, "OnlineGPay");
				}
