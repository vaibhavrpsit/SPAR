 ...
 *	
 *	Rev	1.1 	12-Oct-2018		Purushotham Reddy		Defect Fix- Bug 20399 
...
public class MAXMcouponCheckForCustomerSite extends PosSiteActionAdapter {
	...
	private void displayMobileEnterPrompt(POSUIManagerIfc ui) {
		...
		dialogModel.setButtonLetter(DialogScreensIfc.BUTTON_NO, "CapillaryRequest");
		ui.showScreen(POSUIManagerIfc.DIALOG_TEMPLATE, dialogModel);
	}
}
