...
public class MAXCancelValidateOxigenOTPAisle extends PosLaneActionAdapter {

    protected static Logger logger = Logger.getLogger(MAXCancelValidateOxigenOTPAisle.class);
	...
	public void traverse(BusIfc bus) {
		...
		logger.info("enteredAmt:- "+enteredAmt);
		logger.info("transactionAmt:- "+transactionAmt);
		 
		logger.info("Amount compare:- "+enteredAmt.compareTo(transactionAmt));
