...
public class MAXPaytmWithdrawPrintSite extends PosSiteActionAdapter{
	...
	public void arrive(BusIfc bus)
	{
		...
		try {
			printPaytmSlip(bus, "WITHDRAW", cargo.getPaytmResp(), cargo.getTransaction());
	...
	public void printPaytmSlip(BusIfc bus,String requestType,MAXPaytmResponse paytmResponse, TenderableTransactionIfc trans) 
			throws ParameterException,PrintableDocumentException {
				...
				receipt.setDocumentType(MAXReceiptTypeConstantsIfc.PAYTMCHARGESLIP);
