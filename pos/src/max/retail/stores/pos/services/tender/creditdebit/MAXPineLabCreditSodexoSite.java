 ...
 *
 */
public class MAXPineLabCreditSodexoSite extends PosSiteActionAdapter  {
	...
	public void arrive(BusIfc bus) {
		...
		//	String invoiceNumber = "123"; // no need in sale
			...
			try {
				...
				//System.out.println("92 invalid response");
					String msgLetter = "Invalid";
				...
				if (responseMap != null) {
					...
					String hostResponse = (String) responseMap.get("HostResponse");
					//System.out.println("hostResponse 102:"+hostResponse);
					//System.out.println("responseMap 102:"+responseMap.toString());
					//System.out.println("hostResponseCode 103:"+hostResponseCode);
					...
					if (hostResponse.equals("APPROVED")) {
					
					if (hostResponseCode.equals("00")||hostResponseCode.equals("")) {
...
*/
					...
					//	tenderAttributes.put(MAXTenderConstants.BANK_CODE, bankCode);
						...
						//System.out.println("OnlineCredit");
					}
	...
	public void showDialogBoxMethod(Map responseMap, BusIfc bus, String buttonLetter) {
		//System.out.println("showDialogBoxMethod 202 :");
		DialogBeanModel dialogModel = new DialogBeanModel();
		...
		if (responseMap == null || responseMap.isEmpty()) {
			//System.out.println("Response null 222:");
			String msgLetter = "Invalid";
			showDialogBoxMethod(responseMap, bus, msgLetter);
			return;
		}
	...
	public String getBankCodeFromCardType(HashMap responseMap, String cardType) {
		//System.out.println("responseMap  264:"+responseMap.toString());
	...
	protected void showCardTypeNotAcceptedDialog(POSUIManagerIfc ui) {
		//System.out.println("showCardTypeNotAcceptedDialog");
		DialogBeanModel dialogModel = new DialogBeanModel();
	...
	protected void showInvalidNumberDialog(UtilityManagerIfc utility, POSUIManagerIfc ui) {
		//System.out.println("showInvalidNumberDialog 335");
		DialogBeanModel dialogModel = new DialogBeanModel();
	...
	protected void showExpiredCardDialog(UtilityManagerIfc utility, POSUIManagerIfc ui) {
		//System.out.println("showExpiredCardDialog 356");
	...
	protected void showBadMagStripeDialog(POSUIManagerIfc ui) {
		//System.out.println("showBadMagStripeDialog 378");
		DialogBeanModel dialogModel = new DialogBeanModel();
	...
	protected void showInvalidTenderTypeDialog(POSUIManagerIfc ui) {
		//System.out.println("showInvalidTenderTypeDialog 392");
		DialogBeanModel dialogModel = new DialogBeanModel();
