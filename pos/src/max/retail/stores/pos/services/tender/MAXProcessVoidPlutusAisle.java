...
public class MAXProcessVoidPlutusAisle extends PosLaneActionAdapter
{
    /**
	 * 
	 */
	private static final long serialVersionUID = -3630168931163291420L;
    	...
    	try
        {
    		//Changes done for code merging(commenting below lines for error resolving)
    	           /* MAXCreditChargeSlipReciept chargeSlip = new MAXCreditChargeSlipReciept(cargo
                    .getCurrentTransactionADO(), tenderToRemove.getTenderAttributes(), header, footer, "","VOID");*/
