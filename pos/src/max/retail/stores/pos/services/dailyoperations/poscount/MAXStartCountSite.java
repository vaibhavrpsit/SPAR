...
**/
//--------------------------------------------------------------------------
public class MAXStartCountSite extends PosSiteActionAdapter
{
    /**
        revision number
    **/
    ...
    **/
    ...
    public void arrive(BusIfc bus)
    {
        ...
        if (ft == null)
        {
           ...
           /* if(((MAXPosCountCargo)cargo).isFirstTime())
            {
            	FinancialCountIfc finc = DomainGateway.getFactory().getFinancialCountInstance();
            	ft.getCombinedCount().setEntered(finc);
            	((MAXPosCountCargo)cargo).setFirstTime(false);
            }*/
    ...
    **/
    ...
    protected String getPickupAndLoanLetterName(PosCountCargo cargo, boolean operateWithSafe)
    {
        ...
        {
            boolean cash = "Cash".equals(cargo.getCurrentFLPTender());
