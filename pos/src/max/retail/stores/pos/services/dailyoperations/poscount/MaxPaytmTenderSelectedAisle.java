...
public class MaxPaytmTenderSelectedAisle extends PosLaneActionAdapter
{
	  /**
		 * 
		 */
	...
	/**
	  ...
	  **/
	  ...
	  public void traverse(BusIfc bus)
	  {
	      ...
	      cargo.setCurrentActivityOrCharge(DomainGateway.getFactory().getTenderTypeMapInstance() .getDescriptor(MAXTenderLineItemIfc.TENDER_TYPE_PAYTM));
