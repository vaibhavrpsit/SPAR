...
public class MAXDecimalDocument extends ConstrainedTextDocument
//Changes ends for rev 1.0
{
    ...
    */
    //---------------------------------------------------------------------
    public MAXDecimalDocument()
    {
        this(Integer.MAX_VALUE, DEFAULT_DECIMAL_LENGTH);
    }
    //---------------------------------------------------------------------
   /* public MAXDecimalDocument(int maxValue, int defaultDecimalLength) {
    ...
    */
    //---------------------------------------------------------------------
    public MAXDecimalDocument(int maxLength)
    {
    ...
    */
    //---------------------------------------------------------------------
    public MAXDecimalDocument(int maxLen, int decLen)
    {
        super(maxLen);
// Changes starts for Rev 1.0
		radix = ".";
