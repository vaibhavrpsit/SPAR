...
public class MAXDataErrorReport implements Serializable{
	...
	private MAXEInvoiceErrorResp eInv;
	...
	public MAXEInvoiceErrorResp geteInv() {
		return eInv;
	}
	public void seteInv(MAXEInvoiceErrorResp eInv) {
		this.eInv = eInv;
	}
