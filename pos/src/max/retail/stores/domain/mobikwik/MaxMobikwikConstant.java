package max.retail.stores.domain.mobikwik;

public class MaxMobikwikConstant
{
	...
	public static final String MOBIKWIK_PHONE_NUMBER = "aPhoneNo";
	public static final String MOBIKWIK_TOTP_NUMBER = "aTotpNo";
	...
	// Changes starts for Rev 1.0 (Atul Shuklka :Mobikwik OTP)
	...
	public static final String OTP_MOBIKWIK_PHONE_NUMBER = "cardNumber";
	// Changes ends for Rev 1.0 (Atul :Mobikwik OTP))
}
