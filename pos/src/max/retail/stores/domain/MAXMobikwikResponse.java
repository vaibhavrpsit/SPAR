...
public class MAXMobikwikResponse implements Serializable{
	...
	private String mobikwikResponse;
	private String url;
	...
	/**
	 * @return the MobikwikResponse
	 */
	public String getMobikwikResponse() {
		return mobikwikResponse;
	}
	/**
	 * @param MobikwikResponse the MobikwikResponse to set
	 */
	public void setMobikwikResponse(String mobikwikResponse) {
