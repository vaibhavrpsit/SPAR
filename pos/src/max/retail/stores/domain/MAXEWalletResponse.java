...
public class MAXEWalletResponse implements Serializable {
	...
	private String eWalletTransactionId;
	//Added by vaibhav for EWallet barcode Integration
	...
	public String geteWalletTransactionId() {
		return eWalletTransactionId;
	}

	public void seteWalletTransactionId(String eWalletTransactionId) {
