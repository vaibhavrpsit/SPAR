...
public class MAXJdbcReadBillBusterAmtRuleIDDetails extends JdbcDataOperation implements ARTSDatabaseIfc {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1260672580737780214L;


	public MAXJdbcReadBillBusterAmtRuleIDDetails() {
		super();
		setName("MAXJdbcReadBillBusterAmtRuleIDDetails");
	...
	public void execute(DataTransactionIfc dataTransaction, DataConnectionIfc dataConnection, DataActionIfc action)
		...
		if (logger.isDebugEnabled())
			logger.debug("MAXJdbcReadBillBusterAmtRuleIDDetails.execute");
