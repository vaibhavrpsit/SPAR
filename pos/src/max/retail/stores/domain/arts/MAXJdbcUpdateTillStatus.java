 ...
 **/
// -------------------------------------------------------------------------
public class MAXJdbcUpdateTillStatus extends MAXJdbcSaveTill implements ARTSDatabaseIfc {
	/**
	 * The logger to which log messages will be sent.
	 **/
	private static Logger logger = Logger.getLogger(max.retail.stores.domain.arts.MAXJdbcUpdateTillStatus.class);
	 ...
	 **/
	// ---------------------------------------------------------------------
	public MAXJdbcUpdateTillStatus() {
		super();
	...
	public void execute(DataTransactionIfc dataTransaction, DataConnectionIfc dataConnection, DataActionIfc action)
		...
		if (logger.isDebugEnabled())
			logger.debug("JdbcUpdateTillStatus.execute()");
	 ...
	 **/
	// ---------------------------------------------------------------------
	public boolean updateTillStatus(JdbcDataConnection dataConnection, TillIfc till, RegisterIfc register)
			throws DataException {
