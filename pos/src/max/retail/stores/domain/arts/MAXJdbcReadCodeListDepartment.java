...
import oracle.retail.stores.domain.arts.JdbcReadCodeListDepartment;
...
public class MAXJdbcReadCodeListDepartment extends JdbcReadCodeListDepartment
{
    /**
     ...
     */
    private static Logger logger = Logger.getLogger(max.retail.stores.domain.arts.MAXJdbcReadCodeListDepartment.class);
